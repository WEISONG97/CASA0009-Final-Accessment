...
d3.json("citi-bike/data/citibike-new.json", function(error, data) {
    ...
    function setSlide(i) {
        ...
        g.selectAll(".ab")
            .data(stations)
            .attr("r", function(d) {
                if (d.timeline[currentSlide] > 0) {
                    return rScale(d.timeline[currentSlide]);
                } else {
                    return 0;
                }
            });
        ...
        function change_bg(h) {
            ...
            if (h < 5 || h > 19) { //if yes, change bg to dark (IT'S NIGHT TIME)
                d3.select("body")
                    .transition()
                    .duration(250)
                ...
                d3.selectAll(".description a")
                    ...
                    .duration(250)
                    .style("color", "white");
            } else if (h == 5 || h == 19) { //if no, change bg to white (IT'S DAWN OR DUSK TIME)
                d3.select("body")
                    .transition()
                    .duration(250)
                ...
                d3.selectAll(".description a")
                    ...
                    .duration(250)
                    .style("color", "white");
            } else { //if no, change bg to white (IT'S DAY TIME)
                d3.select("body")
                    .transition()
                    .duration(250)
