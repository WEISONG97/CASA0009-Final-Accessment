    ...
    return (function e(t, n, r) {
        ...
        1: [function(require, module, exports) {
            ...
            function serializePaintVertexArrays(r, e) {
                var t = {};
                for (var a in r) {
                    var n = r[a].paintVertexArray;
                    if (0 !== n.length) {
                        var i = n.serialize(e),
                            s = n.constructor.serialize();
                        t[a] = {
                            array: i,
                            type: s
                        }
            ...
            var ProgramConfiguration = require("./program_configuration"),
                ...
                ArrayGroup = function(r, e, t) {
                    ...
                    var n = r.layoutVertexArrayType;
                    this.layoutVertexArray = new n;
                    var i = r.elementArrayType;
                    i && (this.elementArray = new i);
                    var s = r.elementArrayType2;
                    s && (this.elementArray2 = new s), this.layerData = {};
                    for (var y = 0, o = e; y < o.length; y += 1) {
                        var l = o[y],
                            h = ProgramConfiguration.createDynamic(r.paintAttributes || [], l, t);
                        a.layerData[l.id] = {
                            layer: l,
                            programConfiguration: h,
                            paintVertexArray: new h.PaintVertexArray
                        }
                    }
            ...
            ArrayGroup.prototype.prepareSegment = function(r) {
                ...
                var e = this;
                for (var t in this.layerData) {
                    var a = e.layerData[t];
                    0 !== a.paintVertexArray.bytesPerElement && a.programConfiguration.populatePaintArray(a.layer, a.paintVertexArray, e.layoutVertexArray.length, e.globalProperties, r)
                }
        ...
        2: [function(require, module, exports) {
            ...
            var ArrayGroup = require("./array_group"),
                ...
                Bucket = function(r, e) {
                    this.zoom = r.zoom, this.overscaling = r.overscaling, this.layers = r.layers, this.index = r.index, r.arrays ? this.buffers = new BufferGroup(e, r.layers, r.zoom, r.arrays) : this.arrays = new ArrayGroup(e, r.layers, r.zoom)
                };
            Bucket.prototype.populate = function(r, e) {
                for (var t = this, i = 0, u = r; i < u.length; i += 1) {
                    var a = u[i];
                    t.layers[0].filter(a) && (t.addFeature(a), e.featureIndex.insert(a, t.index))
                }
            ...
            }, module.exports = Bucket, Bucket.deserialize = function(r, e) {
                if (e) {
                    for (var t = {}, i = 0, u = r; i < u.length; i += 1) {
                        var a = u[i],
                            o = a.layerIds.map(function(r) {
                                return e.getLayer(r)
                            }).filter(Boolean);
                        if (0 !== o.length)
                            for (var s = o[0].createBucket(util.extend({
                                    layers: o
                                }, a)), n = 0, f = o; n < f.length; n += 1) {
                                var l = f[n];
                                t[l.id] = s
                            }
                    }
        ...
        3: [function(require, module, exports) {
            ...
            function addCircleVertex(e, r, t, a, p) {
                e.emplaceBack(2 * r + (a + 1) / 2, 2 * t + (p + 1) / 2)
            }
                ...
                CircleBucket = function(e) {
                    ...
                    return e && (r.__proto__ = e), r.prototype = Object.create(e && e.prototype), r.prototype.constructor = r, r.prototype.addFeature = function(e) {
                        for (var r = this.arrays, t = 0, a = loadGeometry(e); t < a.length; t += 1)
                            for (var p = a[t], c = 0, i = p; c < i.length; c += 1) {
                                var y = i[c],
                                    l = y.x,
                                    o = y.y;
                                if (!(l < 0 || l >= EXTENT || o < 0 || o >= EXTENT)) {
                                    var n = r.prepareSegment(4),
                                        u = n.vertexLength;
                                    addCircleVertex(r.layoutVertexArray, l, o, -1, -1), addCircleVertex(r.layoutVertexArray, l, o, 1, -1), addCircleVertex(r.layoutVertexArray, l, o, 1, 1), addCircleVertex(r.layoutVertexArray, l, o, -1, 1), r.elementArray.emplaceBack(u, u + 1, u + 2), r.elementArray.emplaceBack(u, u + 3, u + 2), n.vertexLength += 4, n.primitiveLength += 2
                                }
                            }
            ...
            "../bucket": 2,
            "../element_array_type": 10,
            "../extent": 11,
            "../load_geometry": 13,
            "../vertex_array_type": 17
        }],
                ...
                FillBucket = function(e) {
                    ...
                    return e && (r.__proto__ = e), r.prototype = Object.create(e && e.prototype), r.prototype.constructor = r, r.prototype.addFeature = function(e) {
                        for (var r = this.arrays, t = 0, a = classifyRings(loadGeometry(e), EARCUT_MAX_RINGS); t < a.length; t += 1) {
                            ...
                            for (var i = r.prepareSegment(p), c = i.vertexLength, u = [], h = [], s = 0, g = l; s < g.length; s += 1) {
                                var m = g[s];
                                if (0 !== m.length) {
                                    m !== l[0] && h.push(u.length / 2);
                                    var f = r.prepareSegment2(m.length),
                                        A = f.vertexLength;
                                    r.layoutVertexArray.emplaceBack(m[0].x, m[0].y), r.elementArray2.emplaceBack(A + m.length - 1, A), u.push(m[0].x), u.push(m[0].y);
                                    for (var v = 1; v < m.length; v++) r.layoutVertexArray.emplaceBack(m[v].x, m[v].y), r.elementArray2.emplaceBack(A + v - 1, A + v), u.push(m[v].x), u.push(m[v].y);
                                    f.vertexLength += m.length, f.primitiveLength += m.length
                                }
                            }
                            for (var x = earcut(u, h), _ = 0; _ < x.length; _ += 3) r.elementArray.emplaceBack(c + x[_], c + x[_ + 1], c + x[_ + 2]);
                            i.vertexLength += p, i.primitiveLength += x.length / 3
                        }
                        r.populatePaintArrays(e.properties)
                    }, r
                }(Bucket);
        ...
        5: [function(require, module, exports) {
            ...
            function addVertex(e, r, t, a, n, y, o, i) {
                e.emplaceBack(r, t, 2 * Math.floor(a * FACTOR) + o, n * FACTOR * 2, y * FACTOR * 2, Math.round(i))
            }
            ...
            var Bucket = require("../bucket"),
                ...
                FillExtrusionBucket = function(e) {
                    ...
                    return e && (r.__proto__ = e), r.prototype = Object.create(e && e.prototype), r.prototype.constructor = r, r.prototype.addFeature = function(e) {
                        for (var r = this.arrays, t = 0, a = classifyRings(loadGeometry(e), EARCUT_MAX_RINGS); t < a.length; t += 1) {
                            for (var n = a[t], y = 0, o = 0, i = n; o < i.length; o += 1) {
                                var l = i[o];
                                y += l.length
                            }
                            for (var p = r.prepareSegment(5 * y), u = [], c = [], x = [], s = 0, d = n; s < d.length; s += 1) {
                                var h = d[s];
                                if (0 !== h.length) {
                                    h !== n[0] && c.push(u.length / 2);
                                    for (var m = 0, f = 0; f < h.length; f++) {
                                        var A = h[f];
                                        if (addVertex(r.layoutVertexArray, A.x, A.y, 0, 0, 1, 1, 0), x.push(p.vertexLength++), f >= 1) {
                                            var g = h[f - 1];
                                            if (!isBoundaryEdge(A, g)) {
                                                var _ = A.sub(g)._perp()._unit();
                                                addVertex(r.layoutVertexArray, A.x, A.y, _.x, _.y, 0, 0, m), addVertex(r.layoutVertexArray, A.x, A.y, _.x, _.y, 0, 1, m), m += g.dist(A), addVertex(r.layoutVertexArray, g.x, g.y, _.x, _.y, 0, 0, m), addVertex(r.layoutVertexArray, g.x, g.y, _.x, _.y, 0, 1, m);
                                        ...
                                        u.push(A.x), u.push(A.y)
                                    }
                                }
                            }
                            for (var T = earcut(u, c), E = 0; E < T.length; E += 3) r.elementArray.emplaceBack(x[T[E]], x[T[E + 1]], x[T[E + 2]]);
                            p.primitiveLength += T.length / 3
                        }
                        r.populatePaintArrays(e.properties)
                    }, r
                }(Bucket);
                ...
                LineBucket = function(e) {
                    ...
                    return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.addFeature = function(e) {
                        for (var t = this, r = this.layers[0].layout, i = r["line-join"], a = r["line-cap"], n = r["line-miter-limit"], d = r["line-round-limit"], s = 0, u = loadGeometry(e, LINE_DISTANCE_BUFFER_BITS); s < u.length; s += 1) {
                            var l = u[s];
                            t.addLine(l, e.properties, i, a, n, d)
                        }
                    }, t.prototype.addLine = function(e, t, r, i, a, n) {
                        for (var d = this, s = e.length; s > 2 && e[s - 1].equals(e[s - 2]);) s--;
                        if (!(e.length < 2)) {
                            "bevel" === r && (a = 1.05);
                            var u = SHARP_CORNER_OFFSET * (EXTENT / (512 * this.overscaling)),
                                ...
                                o = l.equals(p),
                                c = this.arrays,
                                _ = c.prepareSegment(10 * s);
                            if (2 !== s || !o) {
                                this.distance = 0;
                                var h, y, m, E, x, C, A, v = i,
                                    f = o ? "butt" : i,
                                    L = !0;
                                this.e1 = this.e2 = this.e3 = -1, o && (h = e[s - 2], x = l.sub(h)._unit()._perp());
                                for (var S = 0; S < s; S++)
                                    if (m = o && S === s - 1 ? e[1] : e[S + 1], !m || !e[S].equals(m)) {
                                        x && (E = x), h && (y = h), h = e[S], x = m ? m.sub(h)._unit()._perp() : E, E = E || x;
                                        var V = E.add(x);
                                        0 === V.x && 0 === V.y || V._unit();
                                        var T = V.x * x.x + V.y * x.y,
                                            I = 0 !== T ? 1 / T : 1 / 0,
                                            N = T < COS_HALF_SHARP_CORNER && y && m;
                                        if (N && S > 0) {
                                            var b = h.dist(y);
                                            if (b > 2 * u) {
                                                var R = h.sub(h.sub(y)._mult(u / b)._round());
                                                d.distance += R.dist(y), d.addCurrentVertex(R, d.distance, E.mult(1), 0, 0, !1, _), y = R
                                            }
                                        }
                                        var g = y && m,
                                            B = g ? r : m ? v : f;
                                        if (g && "round" === B && (I < n ? B = "miter" : I <= 2 && (B = "fakeround")), "miter" === B && I > a && (B = "bevel"), "bevel" === B && (I > 2 && (B = "flipbevel"), I < a && (B = "miter")), y && (d.distance += h.dist(y)), "miter" === B) V._mult(I), d.addCurrentVertex(h, d.distance, V, 0, 0, !1, _);
                                        else if ("flipbevel" === B) {
                                            if (I > 100) V = x.clone().mult(-1);
                                            else {
                                                var F = E.x * x.y - E.y * x.x > 0 ? -1 : 1,
                                                    k = I * E.add(x).mag() / E.sub(x).mag();
                                                V._perp()._mult(k * F)
                                            }
                                            d.addCurrentVertex(h, d.distance, V, 0, 0, !1, _), d.addCurrentVertex(h, d.distance, V.mult(-1), 0, 0, !1, _)
                                        } else if ("bevel" === B || "fakeround" === B) {
                                            var D = E.x * x.y - E.y * x.x > 0,
                                                U = -Math.sqrt(I * I - 1);
                                            if (D ? (A = 0, C = U) : (C = 0, A = U), L || d.addCurrentVertex(h, d.distance, E, C, A, !1, _), "fakeround" === B) {
                                                for (var q, P = Math.floor(8 * (.5 - (T - .5))), M = 0; M < P; M++) q = x.mult((M + 1) / (P + 1))._add(E)._unit(), d.addPieSliceVertex(h, d.distance, q, D, _);
                                                d.addPieSliceVertex(h, d.distance, V, D, _);
                                                for (var O = P - 1; O >= 0; O--) q = E.mult((O + 1) / (P + 1))._add(x)._unit(), d.addPieSliceVertex(h, d.distance, q, D, _)
                                            }
                                            m && d.addCurrentVertex(h, d.distance, x, -C, -A, !1, _)
                                        } else "butt" === B ? (L || d.addCurrentVertex(h, d.distance, E, 0, 0, !1, _), m && d.addCurrentVertex(h, d.distance, x, 0, 0, !1, _)) : "square" === B ? (L || (d.addCurrentVertex(h, d.distance, E, 1, 1, !1, _), d.e1 = d.e2 = -1), m && d.addCurrentVertex(h, d.distance, x, -1, -1, !1, _)) : "round" === B && (L || (d.addCurrentVertex(h, d.distance, E, 0, 0, !1, _), d.addCurrentVertex(h, d.distance, E, 1, 1, !0, _), d.e1 = d.e2 = -1), m && (d.addCurrentVertex(h, d.distance, x, -1, -1, !0, _), d.addCurrentVertex(h, d.distance, x, 0, 0, !1, _)));
                                        if (N && S < s - 1) {
                                            var X = h.dist(m);
                                            if (X > 2 * u) {
                                                var H = h.add(m.sub(h)._mult(u / X)._round());
                                                d.distance += H.dist(h), d.addCurrentVertex(H, d.distance, x.mult(1), 0, 0, !1, _), h = H
                                            }
                                        }
                                        L = !1
                                    }
                                c.populatePaintArrays(t)
                            }
                        }
                    }, t.prototype.addCurrentVertex = function(e, t, r, i, a, n, d) {
                        var s, u = n ? 1 : 0,
                            l = this.arrays,
                            p = l.layoutVertexArray,
                            o = l.elementArray;
                        s = r.clone(), i && s._sub(r.perp()._mult(i)), addLineVertex(p, e, s, u, 0, i, t), this.e3 = d.vertexLength++, this.e1 >= 0 && this.e2 >= 0 && (o.emplaceBack(this.e1, this.e2, this.e3), d.primitiveLength++), this.e1 = this.e2, this.e2 = this.e3, s = r.mult(-1), a && s._sub(r.perp()._mult(a)), addLineVertex(p, e, s, u, 1, -a, t), this.e3 = d.vertexLength++, this.e1 >= 0 && this.e2 >= 0 && (o.emplaceBack(this.e1, this.e2, this.e3), d.primitiveLength++), this.e1 = this.e2, this.e2 = this.e3, t > MAX_LINE_DISTANCE / 2 && (this.distance = 0, this.addCurrentVertex(e, this.distance, r, i, a, n, d))
        ...
        7: [function(require, module, exports) {
            ...
            function addVertex(e, t, o, a, r, i, n, s, l, y, c) {
                e.emplaceBack(t, o, Math.round(64 * a), Math.round(64 * r), i / 4, n / 4, 10 * (y || 0), c, 10 * (s || 0), 10 * Math.min(l || 25, 25))
            }

            function addCollisionBoxVertex(e, t, o, a, r) {
                return e.emplaceBack(t.x, t.y, Math.round(o.x), Math.round(o.y), 10 * a, 10 * r)
            }
            ...
            SymbolBucket.prototype.populate = function(e, t) {
                ...
                if (this.features = [], s || l) {
                    for (var y = t.iconDependencies, c = t.glyphDependencies, d = c[i] = c[i] || {}, h = 0; h < e.length; h++) {
                        var x = e[h];
                        if (o.layers[0].filter(x)) {
                            var u;
                            s && (u = rtlTextPlugin.applyArabicShaping ? rtlTextPlugin.applyArabicShaping(resolveText(x, a)) : resolveText(x, a));
                            var m;
                            if (l && (m = resolveTokens(x.properties, n)), (u || m) && (o.features.push({
                                    text: u,
                                    icon: m,
                                    index: h,
                                    sourceLayerIndex: x.sourceLayerIndex,
                                    geometry: loadGeometry(x),
                                    properties: x.properties,
                                    type: VectorTileFeature.types[x.type]
                                }), m && (y[m] = !0), u))
                                for (var p = 0; p < u.length; p++) d[u.charCodeAt(p)] = !0
                        }
                    }
                ...
                var o = this;
                this.createArrays(), this.adjustedTextMaxSize = this.layers[0].getLayoutValue("text-size", {
                    zoom: 18
                ...
                this.tilePixelRatio = EXTENT / a, this.compareText = {}, this.iconsNeedLinear = !1, this.symbolInstancesStartIndex = this.symbolInstancesArray.length;
                ...
                for (var s = "right" === r["text-justify"] ? 1 : "left" === r["text-justify"] ? 0 : .5, l = 24, y = r["text-line-height"] * l, c = "line" !== r["symbol-placement"] ? r["text-max-width"] * l : 0, d = r["text-letter-spacing"] * l, h = [r["text-offset"][0] * l, r["text-offset"][1] * l], x = this.fontstack = r["text-font"].join(","), u = "map" === r["text-rotation-alignment"] && "line" === r["symbol-placement"], m = 0, p = this.features; m < p.length; m += 1) {
                    var g, f = p[m];
                    if (f.text) {
                        var b = scriptDetection.allowsVerticalWritingMode(f.text);
                        g = {}, g[WritingMode.horizontal] = shapeText(f.text, e[x], c, y, i, n, s, d, h, l, WritingMode.horizontal), g[WritingMode.vertical] = b && u && shapeText(f.text, e[x], c, y, i, n, s, d, h, l, WritingMode.vertical)
                    } else g = {};
                    var I;
                    if (f.icon) {
                        var v = t[f.icon],
                        ...
                        I = shapeIcon(v, S), v && (void 0 === o.sdfIcons ? o.sdfIcons = v.sdf : o.sdfIcons !== v.sdf && util.warnOnce("Style sheet warning: Cannot mix SDF and non-SDF icons in one buffer"), 1 !== v.pixelRatio ? o.iconsNeedLinear = !0 : 0 === r["icon-rotate"] && o.layers[0].isLayoutValueFeatureConstant("icon-rotate") || (o.iconsNeedLinear = !0))
                    }(g[WritingMode.horizontal] || I) && o.addFeature(f, g, I)
                }
                this.symbolInstancesEndIndex = this.symbolInstancesArray.length
            }, SymbolBucket.prototype.addFeature = function(e, t, o) {
                var a = this,
                    r = this.layers[0].layout,
                    i = 24,
                    n = this.adjustedTextSize / i,
                    s = void 0 !== this.adjustedTextMaxSize ? this.adjustedTextMaxSize : this.adjustedTextSize,
                    l = this.tilePixelRatio * n,
                    y = this.tilePixelRatio * s / i,
                    c = this.tilePixelRatio * this.adjustedIconSize,
                    d = this.tilePixelRatio * r["symbol-spacing"],
                    h = r["symbol-avoid-edges"],
                    x = r["text-padding"] * this.tilePixelRatio,
                    u = r["icon-padding"] * this.tilePixelRatio,
                    m = r["text-max-angle"] / 180 * Math.PI,
                    p = "map" === r["text-rotation-alignment"] && "line" === r["symbol-placement"],
                    g = "map" === r["icon-rotation-alignment"] && "line" === r["symbol-placement"],
                    f = r["text-allow-overlap"] || r["icon-allow-overlap"] || r["text-ignore-placement"] || r["icon-ignore-placement"],
                    b = r["symbol-placement"],
                    I = d / 2,
                    v = function(r, i) {
                        var n = !(i.x < 0 || i.x > EXTENT || i.y < 0 || i.y > EXTENT);
                        if (!h || n) {
                            var s = n || f;
                            a.addSymbolInstance(i, r, t, o, a.layers[0], s, a.symbolInstancesArray.length, a.collisionBoxArray, e.index, e.sourceLayerIndex, a.index, l, x, p, c, u, g, {
                                zoom: a.zoom
                            }, e.properties)
                        }
                    };
                if ("line" === b)
                    for (var S = 0, A = clipLine(e.geometry, 0, 0, EXTENT, EXTENT); S < A.length; S += 1)
                        for (var M = A[S], T = getAnchors(M, d, m, t[WritingMode.vertical] || t[WritingMode.horizontal], o, i, y, a.overscaling, EXTENT), B = 0, z = T; B < z.length; B += 1) {
                            var E = z[B],
                                k = t[WritingMode.horizontal];
                            k && a.anchorIsTooClose(k.text, I, E) || v(M, E)
                        } else if ("Polygon" === e.type)
                            for (var P = 0, _ = classifyRings(e.geometry, 0); P < _.length; P += 1) {
                                var L = _[P],
                                    w = findPoleOfInaccessibility(L, 16);
                                v(L[0], new Anchor(w.x, w.y, 0))
                            } else if ("LineString" === e.type)
                                for (var V = 0, Q = e.geometry; V < Q.length; V += 1) {
                                    var j = Q[V];
                                    v(j, new Anchor(j[0].x, j[0].y, 0))
                                } else if ("Point" === e.type)
                                    for (var q = 0, C = e.geometry; q < C.length; q += 1)
                                        for (var F = C[q], N = 0, W = F; N < W.length; N += 1) {
                                            var X = W[N];
                                            v([X], new Anchor(X.x, X.y, 0))
                                        }
            }, SymbolBucket.prototype.anchorIsTooClose = function(e, t, o) {
                var a = this.compareText;
                if (e in a) {
                    for (var r = a[e], i = r.length - 1; i >= 0; i--)
                        if (o.dist(r[i]) < t) return !0
                } else a[e] = [];
                return a[e].push(o), !1
                ...
                var a = this.layers[0].layout,
                    r = e.maxScale,
                    i = "map" === a["text-rotation-alignment"] && "line" === a["symbol-placement"],
                    n = "map" === a["icon-rotation-alignment"] && "line" === a["symbol-placement"],
                    s = a["text-allow-overlap"] || a["icon-allow-overlap"] || a["text-ignore-placement"] || a["icon-ignore-placement"];
                if (s) {
                    var l = this.symbolInstancesArray.toArray(this.symbolInstancesStartIndex, this.symbolInstancesEndIndex),
                        y = e.angle,
                        c = Math.sin(y),
                        d = Math.cos(y);
                    this.sortedSymbolInstances = l.sort(function(e, t) {
                        var o = c * e.anchorPointX + d * e.anchorPointY | 0,
                            a = c * t.anchorPointX + d * t.anchorPointY | 0;
                        return o - a || t.index - e.index
                    })
                }
                for (var h = this.symbolInstancesStartIndex; h < this.symbolInstancesEndIndex; h++) {
                    var x = o.sortedSymbolInstances ? o.sortedSymbolInstances[h - o.symbolInstancesStartIndex] : o.symbolInstancesArray.get(h),
                        u = {
                        ...
                        p = !(x.textBoxStartIndex === x.textBoxEndIndex),
                        g = !(x.iconBoxStartIndex === x.iconBoxEndIndex),
                        f = a["text-optional"] || !p,
                        b = a["icon-optional"] || !g,
                        I = p ? e.placeCollisionFeature(u, a["text-allow-overlap"], a["symbol-avoid-edges"]) : e.minScale,
                        v = g ? e.placeCollisionFeature(m, a["icon-allow-overlap"], a["symbol-avoid-edges"]) : e.minScale;
                    f || b ? !b && I ? I = Math.max(v, I) : !f && v && (v = Math.max(v, I)) : v = I = Math.max(v, I), p && (e.insertCollisionFeature(u, I, a["text-ignore-placement"]), I <= r && o.addSymbols(o.arrays.glyph, x.glyphQuadStartIndex, x.glyphQuadEndIndex, I, a["text-keep-upright"], i, e.angle, x.writingModes)), g && (e.insertCollisionFeature(m, v, a["icon-ignore-placement"]), v <= r && o.addSymbols(o.arrays.icon, x.iconQuadStartIndex, x.iconQuadEndIndex, v, a["icon-keep-upright"], n, e.angle))
                }
                t && this.addToDebugBuffers(e)
            }, SymbolBucket.prototype.addSymbols = function(e, t, o, a, r, i, n, s) {
                for (var l = this, y = e.elementArray, c = e.layoutVertexArray, d = this.zoom, h = Math.max(Math.log(a) / Math.LN2 + d, 0), x = t; x < o; x++) {
                    var u = l.symbolQuadsArray.get(x).SymbolQuad,
                        m = (u.anchorAngle + n + Math.PI) % (2 * Math.PI);
                    if (s & WritingMode.vertical) {
                        if (i && u.writingMode === WritingMode.vertical) {
                            if (r && i && m <= 5 * Math.PI / 4 || m > 7 * Math.PI / 4) continue
                        } else if (r && i && m <= 3 * Math.PI / 4 || m > 5 * Math.PI / 4) continue
                    } else if (r && i && (m <= Math.PI / 2 || m > 3 * Math.PI / 2)) continue;
                    var p = u.tl,
                        g = u.tr,
                        f = u.bl,
                        b = u.br,
                        I = u.tex,
                        v = u.anchorPoint,
                        S = Math.max(d + Math.log(u.minScale) / Math.LN2, h),
                        A = Math.min(d + Math.log(u.maxScale) / Math.LN2, 25);
                    if (!(A <= S)) {
                        S === h && (S = 0);
                        var M = Math.round(u.glyphAngle / (2 * Math.PI) * 256),
                            T = e.prepareSegment(4),
                            B = T.vertexLength;
                        addVertex(c, v.x, v.y, p.x, p.y, I.x, I.y, S, A, h, M), addVertex(c, v.x, v.y, g.x, g.y, I.x + I.w, I.y, S, A, h, M), addVertex(c, v.x, v.y, f.x, f.y, I.x, I.y + I.h, S, A, h, M), addVertex(c, v.x, v.y, b.x, b.y, I.x + I.w, I.y + I.h, S, A, h, M), y.emplaceBack(B, B + 1, B + 2), y.emplaceBack(B + 1, B + 2, B + 3), T.vertexLength += 4, T.primitiveLength += 2
                    }
                }
            }, SymbolBucket.prototype.addToDebugBuffers = function(e) {
                for (var t = this, o = this.arrays.collisionBox, a = o.layoutVertexArray, r = o.elementArray, i = -e.angle, n = e.yStretch, s = this.symbolInstancesStartIndex; s < this.symbolInstancesEndIndex; s++) {
                    var l = t.symbolInstancesArray.get(s);
                    l.textCollisionFeature = {
                        boxStartIndex: l.textBoxStartIndex,
                        boxEndIndex: l.textBoxEndIndex
                    }, l.iconCollisionFeature = {
                        boxStartIndex: l.iconBoxStartIndex,
                        boxEndIndex: l.iconBoxEndIndex
                    };
                    for (var y = 0; y < 2; y++) {
                        var c = l[0 === y ? "textCollisionFeature" : "iconCollisionFeature"];
                        if (c)
                            for (var d = c.boxStartIndex; d < c.boxEndIndex; d++) {
                                var h = t.collisionBoxArray.get(d),
                                    x = h.anchorPoint,
                                    u = new Point(h.x1, h.y1 * n)._rotate(i),
                                    m = new Point(h.x2, h.y1 * n)._rotate(i),
                                    p = new Point(h.x1, h.y2 * n)._rotate(i),
                                    g = new Point(h.x2, h.y2 * n)._rotate(i),
                                    f = Math.max(0, Math.min(25, t.zoom + Math.log(h.maxScale) / Math.LN2)),
                                    b = Math.max(0, Math.min(25, t.zoom + Math.log(h.placementScale) / Math.LN2)),
                                    I = o.prepareSegment(4),
                                    v = I.vertexLength;
                                addCollisionBoxVertex(a, x, u, f, b), addCollisionBoxVertex(a, x, m, f, b), addCollisionBoxVertex(a, x, g, f, b), addCollisionBoxVertex(a, x, p, f, b), r.emplaceBack(v, v + 1), r.emplaceBack(v + 1, v + 2), r.emplaceBack(v + 2, v + 3), r.emplaceBack(v + 3, v), I.vertexLength += 4, I.primitiveLength += 4
                            }
                    }
                }
            }, SymbolBucket.prototype.addSymbolInstance = function(e, t, o, a, r, i, n, s, l, y, c, d, h, x, u, m, p, g, f) {
                var b, I, v, S = this,
                    A = [];
                for (var M in o) {
                    var T = parseInt(M, 10);
                    o[T] && (A = A.concat(i ? getGlyphQuads(e, o[T], d, t, r, x, T) : []), b = new CollisionFeature(s, t, e, l, y, c, o[T], d, h, x, !1))
                }
                var B = this.symbolQuadsArray.length;
                if (A && A.length)
                    for (var z = 0; z < A.length; z++) S.addSymbolQuad(A[z]);
                var E = this.symbolQuadsArray.length,
                    k = b ? b.boxStartIndex : this.collisionBoxArray.length,
                    P = b ? b.boxEndIndex : this.collisionBoxArray.length;
                a && (v = i ? getIconQuads(e, a, u, t, r, p, o[WritingMode.horizontal], g, f) : [], I = new CollisionFeature(s, t, e, l, y, c, a, u, m, p, !0));
                var _ = this.symbolQuadsArray.length;
                v && 1 === v.length && this.addSymbolQuad(v[0]);
                var L = this.symbolQuadsArray.length,
                    w = I ? I.boxStartIndex : this.collisionBoxArray.length,
                    V = I ? I.boxEndIndex : this.collisionBoxArray.length;
                L > SymbolBucket.MAX_QUADS && util.warnOnce("Too many symbols being rendered in a tile. See https://github.com/mapbox/mapbox-gl-js/issues/2907"), E > SymbolBucket.MAX_QUADS && util.warnOnce("Too many glyphs being rendered in a tile. See https://github.com/mapbox/mapbox-gl-js/issues/2907");
                var Q = (o[WritingMode.vertical] ? WritingMode.vertical : 0) | (o[WritingMode.horizontal] ? WritingMode.horizontal : 0);
                return this.symbolInstancesArray.emplaceBack(k, P, w, V, B, E, _, L, e.x, e.y, n, Q)
            }, SymbolBucket.prototype.addSymbolQuad = function(e) {
                return this.symbolQuadsArray.emplaceBack(e.anchorPoint.x, e.anchorPoint.y, e.tl.x, e.tl.y, e.tr.x, e.tr.y, e.bl.x, e.bl.y, e.br.x, e.br.y, e.tex.h, e.tex.w, e.tex.x, e.tex.y, e.anchorAngle, e.glyphAngle, e.maxScale, e.minScale, e.writingMode)
            }, SymbolBucket.MAX_QUADS = 65535, module.exports = SymbolBucket;
        }, {
            "../../source/rtl_text_plugin": 49,
            "../../symbol/anchor": 75,
            "../../symbol/clip_line": 77,
            "../../symbol/collision_feature": 79,
            "../../symbol/get_anchors": 81,
            "../../symbol/mergelines": 84,
            "../../symbol/quads": 85,
            "../../symbol/resolve_text": 86,
            "../../symbol/shaping": 87,
            "../../util/classify_rings": 113,
            "../../util/find_pole_of_inaccessibility": 119,
            "../../util/script_detection": 126,
            "../../util/token": 128,
            "../../util/util": 129,
            "../array_group": 1,
            "../buffer_group": 9,
        ...
        9: [function(require, module, exports) {
            ...
            var util = require("../util/util"),
                ...
                BufferGroup = function(e, r, t, a) {
                    ...
                    for (var i = 0, n = r; i < n.length; i += 1) {
                        var u = n[i],
                            s = a.paintVertexArrays && a.paintVertexArrays[u.id],
                            o = ProgramConfiguration.createDynamic(e.paintAttributes || [], u, t),
                    ...
                    for (var l = 0, m = [this.segments, this.segments2]; l < m.length; l += 1)
                        for (var B = m[l], h = 0, p = B || []; h < p.length; h += 1) {
                            var g = p[h];
                            g.vaos = util.mapObject(f.layerData, function() {
            ...
            BufferGroup.prototype.destroy = function() {
                ...
                for (var r in this.layerData) {
                    var t = e.layerData[r].paintVertexBuffer;
                    t && t.destroy()
                }
                for (var a = 0, f = [this.segments, this.segments2]; a < f.length; a += 1)
                    for (var i = f[a], n = 0, u = i || []; n < u.length; n += 1) {
                        var s = u[n];
                        for (var o in s.vaos) s.vaos[o].destroy()
                    }
            }, module.exports = BufferGroup;
        }, {
            "../render/vertex_array_object": 39,
            "../util/util": 129,
            "./buffer": 8,
            "./program_configuration": 15
        }],
        ...
        12: [function(require, module, exports) {
                ...
                for (var r = [], i = new Point(0, 0), n = 0; n < e.length; n++) {
                    for (var a = e[n], o = [], s = 0; s < a.length; s++) {
                        var l = a[s - 1],
                            ...
                            d = y._add(f)._unit(),
                            h = d.x * f.x + d.y * f.y;
                        d._mult(1 / h), o.push(d._mult(t)._add(u))
                    }
                    r.push(o)
                }
                return r
            ...
            FeatureIndex.prototype.insert = function(e, t) {
                ...
                for (var n = loadGeometry(e), a = 0; a < n.length; a++) {
                    for (var o = n[a], s = [1 / 0, 1 / 0, -(1 / 0), -(1 / 0)], l = 0; l < o.length; l++) {
                        var u = o[l];
                        s[0] = Math.min(s[0], u.x), s[1] = Math.min(s[1], u.y), s[2] = Math.max(s[2], u.x), s[3] = Math.max(s[3], u.y)
                    }
                    r.grid.insert(i, s[0], s[1], s[2], s[3])
                }
                ...
                for (var s in t) {
                    var l = t[s],
                        u = l.paint,
                        c = 0;
                    "line" === l.type ? c = getLineWidth(u) / 2 + Math.abs(u["line-offset"]) + translateDistance(u["line-translate"]) : "fill" === l.type ? c = translateDistance(u["fill-translate"]) : "fill-extrusion" === l.type ? c = translateDistance(u["fill-extrusion-translate"]) : "circle" === l.type && (c = u["circle-radius"] + translateDistance(u["circle-translate"])), o = Math.max(o, c * n)
                }
                for (var y = e.queryGeometry.map(function(e) {
                        return e.map(function(e) {
                            return new Point(e.x, e.y)
                        })
                    }), f = 1 / 0, d = 1 / 0, h = -(1 / 0), g = -(1 / 0), p = 0; p < y.length; p++)
                    for (var v = y[p], x = 0; x < v.length; x++) {
                        var I = v[x];
                        f = Math.min(f, I.x), d = Math.min(d, I.y), h = Math.max(h, I.x), g = Math.max(g, I.y)
                    }
                var m = this.grid.query(f - o, d - o, h + o, g + o);
                m.sort(topDownFeatureComparator), this.filterMatching(r, m, this.featureIndexArray, y, a, i.layers, t, e.bearing, n);
                var L = this.collisionTile.queryRenderedSymbols(y, e.scale);
                return L.sort(), this.filterMatching(r, L, this.collisionTile.collisionBoxArray, y, a, i.layers, t, e.bearing, n), r
                ...
                for (var u, c = this, y = 0; y < t.length; y++) {
                    ...
                    if (f !== u) {
                        ...
                        if (!a || arraysIntersect(a, h)) {
                            ...
                            if (n(v))
                                for (var x = null, I = 0; I < h.length; I++) {
                                    var m = h[I];
                                    if (!(a && a.indexOf(m) < 0)) {
                                        var L = o[m];
                                        if (L) {
                                            ...
                                            if ("symbol" !== L.type) {
                                                ...
                                                var P = L.paint;
                                                if ("line" === L.type) {
                                                    M = translate(i, P["line-translate"], P["line-translate-anchor"], s, l);
                                                    var b = getLineWidth(P) / 2 * l;
                                                    if (P["line-offset"] && (x = offsetLine(x, P["line-offset"] * l)), !multiPolygonIntersectsBufferedMultiLine(M, x, b)) continue
                                                } else if ("fill" === L.type || "fill-extrusion" === L.type) {
                                                    var w = L.type;
                                                    if (M = translate(i, P[w + "-translate"], P[w + "-translate-anchor"], s, l), !multiPolygonIntersectsMultiPolygon(M, x)) continue
                                                } else if ("circle" === L.type) {
                                                    M = translate(i, P["circle-translate"], P["circle-translate-anchor"], s, l);
                                                    var _ = P["circle-radius"] * l;
                                                    if (!multiPolygonIntersectsBufferedMultiPoint(M, x, _)) continue
                                                }
                                            }
                                            var q = new GeoJSONFeature(v, c.z, c.x, c.y);
                                            q.layer = L.serialize();
                                            var T = e[m];
                                            void 0 === T && (T = e[m] = []), T.push(q)
                                        }
                                    }
                                }
                        }
            ...
            "../util/dictionary_coder": 115,
            "../util/intersection_tests": 122,
            "../util/struct_array": 127,
            "../util/util": 129,
            "../util/vectortile_to_geojson": 130,
            "./extent": 11,
            "./load_geometry": 13,
            "feature-filter": 138,
            "grid-index": 149,
        ...
        15: [function(require, module, exports) {
            ...
            function getPaintAttributeValue(t, e, r, i) {
                if (!t.zoomStops) return e.getPaintValue(t.property, r, i);
                var a = t.zoomStops.map(function(a) {
                    return e.getPaintValue(t.property, util.extend({}, r, {
                        zoom: a
                    }), i)
                });
            ...
            function normalizePaintAttribute(t, e) {
                var r = t.property.replace(e.type + "-", "").replace(/-/g, "_"),
                    i = "color" === e._paintSpecifications[t.property].type;
                return util.extend({
                    name: "a_" + r,
                    components: i ? 4 : 1,
                    multiplier: i ? 255 : 1
            ...
            ProgramConfiguration.createDynamic = function(t, e, r) {
                for (var i = new ProgramConfiguration, a = 0, n = t; a < n.length; a += 1) {
                    var o = n[a],
                        p = normalizePaintAttribute(o, e),
                        u = p.name.slice(2);
                    e.isPaintValueFeatureConstant(p.property) ? i.addZoomAttribute(u, p) : e.isPaintValueZoomConstant(p.property) ? i.addPropertyAttribute(u, p) : i.addZoomAndPropertyAttribute(u, p, e, r)
                }
                return i.PaintVertexArray = createVertexArrayType(i.attributes), i
            }, ProgramConfiguration.createStatic = function(t) {
                for (var e = new ProgramConfiguration, r = 0, i = t; r < i.length; r += 1) {
                    var a = i[r];
                    e.addUniform(a, "u_" + a)
                }
                return e
            }, ProgramConfiguration.prototype.addUniform = function(t, e) {
                var r = this.getPragmas(t);
                r.define.push("uniform {precision} {type} " + e + ";"), r.initialize.push("{precision} {type} " + t + " = " + e + ";"), this.cacheKey += "/u_" + t
            }, ProgramConfiguration.prototype.addZoomAttribute = function(t, e) {
                this.uniforms.push(e), this.addUniform(t, e.name)
            }, ProgramConfiguration.prototype.addPropertyAttribute = function(t, e) {
                var r = this.getPragmas(t);
                this.attributes.push(e), r.define.push("varying {precision} {type} " + t + ";"), r.vertex.define.push("attribute {precision} {type} " + e.name + ";"), r.vertex.initialize.push(t + " = " + e.name + " / " + e.multiplier + ".0;"), this.cacheKey += "/a_" + t
            }, ProgramConfiguration.prototype.addZoomAndPropertyAttribute = function(t, e, r, i) {
                var a = this,
                    n = this.getPragmas(t);
                n.define.push("varying {precision} {type} " + t + ";");
                for (var o = 0, p = r.getPaintValueStopZoomLevels(e.property); o < p.length && p[o] < i;) o++;
                ...
                var g = [];
                if (1 === e.components) this.attributes.push(util.extend({}, e, {
                    components: 4,
                    zoomStops: m
                })), n.vertex.define.push("attribute {precision} vec4 " + e.name + ";"), g.push(e.name);
                else
                    for (var h = 0; h < 4; h++) {
                        var l = e.name + h;
                        g.push(l), a.attributes.push(util.extend({}, e, {
                            name: l,
                            zoomStops: [m[h]]
                        })), n.vertex.define.push("attribute {precision} {type} " + l + ";")
                    }
                n.vertex.initialize.push(t + " = evaluate_zoom_function_" + e.components + "(            " + g.join(", ") + ", " + s + ") / " + e.multiplier + ".0;"), this.cacheKey += "/z_" + t
            ...
            }, ProgramConfiguration.prototype.applyPragmas = function(t, e) {
                var r = this;
                return t.replace(/#pragma mapbox: ([\w]+) ([\w]+) ([\w]+) ([\w]+)/g, function(t, i, a, n, o) {
                    return r.pragmas[o][i].concat(r.pragmas[o][e][i]).join("\n").replace(/{type}/g, n).replace(/{precision}/g, a)
                })
            }, ProgramConfiguration.prototype.populatePaintArray = function(t, e, r, i, a) {
                var n = e.length;
                e.resize(r);
                for (var o = 0, p = this.attributes; o < p.length; o += 1)
                    for (var u = p[o], s = getPaintAttributeValue(u, t, i, a), m = n; m < r; m++) {
                        var f = e.get(m);
                        if (4 === u.components)
                            for (var g = 0; g < 4; g++) f[u.name + g] = s[g] * u.multiplier;
                        else f[u.name] = s * u.multiplier
                    }
            }, ProgramConfiguration.prototype.setUniforms = function(t, e, r, i) {
                for (var a = 0, n = this.uniforms; a < n.length; a += 1) {
                    var o = n[a],
                        p = r.getPaintValue(o.property, i);
                    4 === o.components ? t.uniform4fv(e[o.name], p) : t.uniform1f(e[o.name], p)
                }
                for (var u = 0, s = this.interpolationUniforms; u < s.length; u += 1) {
                    var m = s[u],
                        f = r.getPaintInterpolationT(m.property, i);
                    t.uniform1f(e[m.name], Math.max(0, Math.min(4, f - m.stopOffset)))
                }
        ...
        21: [function(require, module, exports) {
            ...
            "../data/extent": 11,
            "../source/tile_coord": 53,
            "../util/interpolate": 121,
            "../util/util": 129,
            "./coordinate": 18,
            "./lng_lat": 19,
            "@mapbox/gl-matrix": 133,
            "point-geometry": 197
        }],
            ...
            module.exports = function(l, n, t, e) {
                ...
                for (r = 0, o = l.length; r < o; r++)
                    if (i = simplexFont[l[r]]) {
                        for (p = null, u = 0, s = i[1].length; u < s; u += 2) i[1][u] === -1 && i[1][u + 1] === -1 ? p = null : (x = n + i[1][u] * e, f = t - i[1][u + 1] * e, p && h.push(p.x, p.y, x, f), p = {
                            x: x,
                            y: f
                        });
                        n += i[0] * e
        ...
        24: [function(require, module, exports) {
            ...
            "../package.json": 216,
            "./geo/lng_lat": 19,
            "./geo/lng_lat_bounds": 20,
            "./source/rtl_text_plugin": 49,
            "./style/style": 63,
            "./ui/control/attribution_control": 93,
            "./ui/control/geolocate_control": 94,
            "./ui/control/navigation_control": 95,
            "./ui/control/scale_control": 96,
            "./ui/map": 105,
            "./ui/marker": 106,
            "./ui/popup": 107,
            "./util/ajax": 109,
        ...
        28: [function(require, module, exports) {
            ...
            function drawDebugTile(r, e, a) {
                ...
                for (var o = textVertices(a.toString(), 50, 200, 5), f = new PosArray, n = 0; n < o.length; n += 2) f.emplaceBack(o[n], o[n + 1]);
                var l = Buffer.fromStructArray(f, Buffer.BufferType.VERTEX),
                    b = new VertexArrayObject;
                b.bind(t, u, l), t.uniform4f(u.u_color, 1, 1, 1, 1);
                for (var d = e.getTile(a).tileSize, g = EXTENT / (Math.pow(2, r.transform.zoom - a.z) * d), m = [
                        [-1, -1],
                        [-1, 1],
                        [1, -1],
                        [1, 1]
                    ...
                    var x = m[s];
                    t.uniformMatrix4fv(u.u_matrix, !1, mat4.translate([], i, [g * x[0], g * x[1], 0])), t.drawArrays(t.LINES, 0, l.length)
                }
        ...
        31: [function(require, module, exports) {
            ...
            "../source/pixels_to_tile_units": 46,
            "../util/browser": 110
        }],
        32: [function(require, module, exports) {
            ...
            function drawRaster(r, t, a, e) {
                if (!r.isOpaquePass) {
                    ...
                    for (var o = e.length && e[0].z, n = 0; n < e.length; n++) {
                        var u = e[n];
                        r.setDepthSublayer(u.z - o), drawRasterTile(r, t, a, u)
                    }
            ...
            function drawRasterTile(r, t, a, e) {
                ...
                var o = t.getTile(e),
                    n = r.transform.calculatePosMatrix(e, t.getSource().maxzoom);
                o.registerFadeDuration(r.style.animationLoop, a.paint["raster-fade-duration"]);
                var u = r.useProgram("raster");
                i.uniformMatrix4fv(u.u_matrix, !1, n), i.uniform1f(u.u_brightness_low, a.paint["raster-brightness-min"]), i.uniform1f(u.u_brightness_high, a.paint["raster-brightness-max"]), i.uniform1f(u.u_saturation_factor, saturationFactor(a.paint["raster-saturation"])), i.uniform1f(u.u_contrast_factor, contrastFactor(a.paint["raster-contrast"])), i.uniform3fv(u.u_spin_weights, spinWeights(a.paint["raster-hue-rotate"]));
                var s, c, f = o.sourceCache && o.sourceCache.findLoadedParent(e, 0, {}),
                    d = getFadeValues(o, f, a, r.transform);
                ...
                var m = o.boundsBuffer || r.rasterBoundsBuffer,
                    h = o.boundsVAO || r.rasterBoundsVAO;
                h.bind(i, u, m), i.drawArrays(i.TRIANGLE_STRIP, 0, m.length)
            }
        ...
        33: [function(require, module, exports) {
            ...
            function drawSymbols(t, e, i, a) {
                if (!t.isOpaquePass) {
                    var o = !(i.layout["text-allow-overlap"] || i.layout["icon-allow-overlap"] || i.layout["text-ignore-placement"] || i.layout["icon-ignore-placement"]),
                        r = t.gl;
                    o ? r.disable(r.STENCIL_TEST) : r.enable(r.STENCIL_TEST), t.setDepthSublayer(0), t.depthMask(!1), drawLayerSymbols(t, e, i, a, !1, i.paint["icon-translate"], i.paint["icon-translate-anchor"], i.layout["icon-rotation-alignment"], i.layout["icon-rotation-alignment"], i.layout["icon-size"], i.paint["icon-halo-width"], i.paint["icon-halo-color"], i.paint["icon-halo-blur"], i.paint["icon-opacity"], i.paint["icon-color"]), drawLayerSymbols(t, e, i, a, !0, i.paint["text-translate"], i.paint["text-translate-anchor"], i.layout["text-rotation-alignment"], i.layout["text-pitch-alignment"], i.layout["text-size"], i.paint["text-halo-width"], i.paint["text-halo-color"], i.paint["text-halo-blur"], i.paint["text-opacity"], i.paint["text-color"]), e.map.showCollisionBoxes && drawCollisionDebug(t, e, i, a)
                }
            }

            function drawLayerSymbols(t, e, i, a, o, r, n, l, s, u, f, m, c, p, d) {
                if (o || !t.style.sprite || t.style.sprite.loaded()) {
                    var h = t.gl,
                        b = "map" === l,
                        x = "map" === s,
                        g = x;
                    g ? h.enable(h.DEPTH_TEST) : h.disable(h.DEPTH_TEST);
                    for (var _, y, T = 0, v = a; T < v.length; T += 1) {
                        var w = v[T],
                            S = e.getTile(w),
                            E = S.getBucket(i);
                        if (E) {
                            var P = o ? E.buffers.glyph : E.buffers.icon;
                            if (P && P.segments.length) {
                                var D = o || E.sdfIcons;
                                _ && E.fontstack === y || (_ = t.useProgram(D ? "symbolSDF" : "symbolIcon"), setSymbolDrawState(_, t, o, D, b, x, E.fontstack, u, E.iconsNeedLinear, o ? E.adjustedTextSize : E.adjustedIconSize, p)), t.enableTileClippingMask(w), h.uniformMatrix4fv(_.u_matrix, !1, t.translatePosMatrix(w.posMatrix, S, r, n)), drawTileSymbols(_, t, i, S, P, o, D, x, u, f, m, c, d), y = E.fontstack
                            }
                        }
                    }
                    g || h.enable(h.DEPTH_TEST)
                }
            }

            function setSymbolDrawState(t, e, i, a, o, r, n, l, s, u, f) {
                var m = e.gl,
                    c = e.transform;
                if (m.uniform1i(t.u_rotate_with_map, o), m.uniform1i(t.u_pitch_with_map, r), m.activeTexture(m.TEXTURE0), m.uniform1i(t.u_texture, 0), i) {
                    var p = n && e.glyphSource.getGlyphAtlas(n);
                    if (!p) return;
                    p.updateTexture(m), m.uniform2f(t.u_texsize, p.width / 4, p.height / 4)
                } else {
                    var d = e.options.rotating || e.options.zooming,
                        h = 1 !== l || browser.devicePixelRatio !== e.spriteAtlas.pixelRatio || s,
                        b = r || c.pitch;
                    e.spriteAtlas.bind(m, a || d || h || b), m.uniform2f(t.u_texsize, e.spriteAtlas.width / 4, e.spriteAtlas.height / 4)
                }
                m.activeTexture(m.TEXTURE1), e.frameHistory.bind(m), m.uniform1i(t.u_fadetexture, 1);
                var x = Math.log(l / u) / Math.LN2 || 0;
                m.uniform1f(t.u_zoom, 10 * (c.zoom - x)), m.uniform1f(t.u_pitch, c.pitch / 360 * 2 * Math.PI), m.uniform1f(t.u_bearing, c.bearing / 360 * 2 * Math.PI), m.uniform1f(t.u_aspect_ratio, c.width / c.height), m.uniform1f(t.u_opacity, f)
            }

            function drawTileSymbols(t, e, i, a, o, r, n, l, s, u, f, m, c) {
                var p = e.gl,
                    d = e.transform,
                    h = s / (r ? 24 : 1);
                if (l) {
                    var b = pixelsToTileUnits(a, h, d.zoom);
                    p.uniform2f(t.u_extrude_scale, b, b)
                } else {
                    var x = d.cameraToCenterDistance * h;
                    p.uniform2f(t.u_extrude_scale, d.pixelsToGLUnits[0] * x, d.pixelsToGLUnits[1] * x)
                }
                if (n) {
                    var g = h * (l ? Math.cos(d._pitch) : 1) * d.cameraToCenterDistance;
                    u && (p.uniform1f(t.u_gamma, (m * blurOffset / sdfPx + gamma) / g), p.uniform4fv(t.u_color, f), p.uniform1f(t.u_buffer, (haloOffset - u / h) / sdfPx), drawSymbolElements(o, i, p, t)), p.uniform1f(t.u_gamma, gamma / g), p.uniform4fv(t.u_color, c), p.uniform1f(t.u_buffer, .75)
                }
                drawSymbolElements(o, i, p, t)
            }

            function drawSymbolElements(t, e, i, a) {
                for (var o = 0, r = t.segments; o < r.length; o += 1) {
                    var n = r[o];
                    n.vaos[e.id].bind(i, a, t.layoutVertexBuffer, t.elementBuffer, null, n.vertexOffset), i.drawElements(i.TRIANGLES, 3 * n.primitiveLength, i.UNSIGNED_SHORT, 3 * n.primitiveOffset * 2)
                }
            }
            var browser = require("../util/browser"),
            ...
            var sdfPx = 8,
                blurOffset = 1.19,
                haloOffset = 6,
                gamma = .105 / browser.devicePixelRatio;
        }, {
            "../source/pixels_to_tile_units": 46,
            "../util/browser": 110,
        ...
        35: [function(require, module, exports) {
            ...
            LineAtlas.prototype.setSprite = function(t) {
                ...
                for (var E = this.width / r, o = E / 2, T = t.length % 2 === 1, R = -h; R <= h; R++)
                    for (var u = e.nextRow + h + R, d = e.width * u, l = T ? -t[t.length - 1] : 0, x = t[0], A = 1, _ = 0; _ < this.width; _++) {
                        for (; x < _ / E;) l = x, x += t[A], T && A === t.length - 1 && (x += t[0]), A++;
                        var p, g = Math.abs(_ - l * E),
                            w = Math.abs(_ - x * E),
                            D = Math.min(g, w),
                            U = A % 2 === 1;
                        if (i) {
                            ...
                            if (U) {
                                var X = o - Math.abs(f);
                                p = Math.sqrt(D * D + X * X)
                            } else p = o - Math.sqrt(D * D + f * f)
                        } else p = (U ? 1 : -1) * D;
                        e.data[3 + 4 * (d + _)] = Math.max(0, Math.min(255, p + a))
                    }
                var y = {
                ...
                return this.nextRow += s, this.dirty = !0, y
        ...
        36: [function(require, module, exports) {
            ...
            Painter.prototype.resize = function(e, r) {
                ...
                t.shaderSource(o, r.applyPragmas(s + shaders.prelude.fragmentSource + a.fragmentSource, "fragment")), t.compileShader(o), t.attachShader(i, o);
                var n = t.createShader(t.VERTEX_SHADER);
                t.shaderSource(n, r.applyPragmas(s + shaders.prelude.vertexSource + a.vertexSource, "vertex")), t.compileShader(n), t.attachShader(i, n), t.linkProgram(i);
                for (var l = t.getProgramParameter(i, t.ACTIVE_ATTRIBUTES), h = {
                        program: i,
                        numAttributes: l
                    }, u = 0; u < l; u++) {
                    var c = t.getActiveAttrib(i, u);
                    h[c.name] = t.getAttribLocation(i, c.name)
                }
                for (var p = t.getProgramParameter(i, t.ACTIVE_UNIFORMS), d = 0; d < p; d++) {
                    var f = t.getActiveUniform(i, d);
                    h[f.name] = t.getUniformLocation(i, f.name)
                }
                return h
            ...
            "../data/extent": 11,
            "../data/pos_array": 14,
            "../data/program_configuration": 15,
            "../data/raster_bounds_array": 16,
            "../source/pixels_to_tile_units": 46,
            "../source/source_cache": 51,
            "../util/browser": 110,
            "../util/util": 129,
            "./draw_background": 25,
            "./draw_circle": 26,
        ...
        40: [function(require, module, exports) {
            ...
            var ImageSource = require("./image_source"),
                ...
                CanvasSource = function(t) {
                    function i(i, s, a, n) {
                        t.call(this, i, s, a, n), this.options = s, this.animate = !s.hasOwnProperty("animate") || s.animate
                    }
                    return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.prototype.load = function() {
                        if (this.canvas = this.canvas || window.document.getElementById(this.options.canvas), this.width = this.canvas.width, this.height = this.canvas.height, this._hasInvalidDimensions(this.canvas)) return this.fire("error", new Error("Canvas dimensions cannot be less than or equal to zero."));
                        var t;
                        this.play = function() {
                        ...
                        this.map || (this.map = t, this.load(), this.canvas && (this.animate && this.play(), this.setCoordinates(this.coordinates)))
                        ...
                        for (var t = 0, i = [this.canvas.width, this.canvas.height]; t < i.length; t += 1) {
                            var s = i[t];
            ...
            var util = require("../util/util"),
                ...
                ImageSource = function(t) {
                    ...
                    return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.load = function() {
                        ...
                        this.fire("source.load"), this.map && this.setCoordinates(this.coordinates)
                    }, e.prototype.onAdd = function(t) {
                ...
                RasterTileSource = function(e) {
                    ...
                    return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.load = function() {
                        ...
                        function i(i, r) {
                            ...
                            e.setExpiryData(r), delete r.cacheControl, delete r.expires;
        ...
        49: [function(require, module, exports) {
            ...
            var ajax = require("../util/ajax"),
                window = require("../util/window"),
                pluginAvailableCallbacks = [],
                pluginRequested = !1,
                pluginBlobURL = null;
            module.exports.registerForPluginAvailability = function(l) {
                pluginBlobURL ? l(pluginBlobURL) : pluginAvailableCallbacks.push(l)
            }, module.exports.errorCallback = null, module.exports.setRTLTextPlugin = function(l, e) {
                if (pluginRequested) throw new Error("setRTLTextPlugin cannot be called multiple times.");
                pluginRequested = !0, module.exports.errorCallback = e, ajax.getArrayBuffer(l, function(l, i) {
                    if (l) e(l);
                    else {
                        pluginBlobURL = window.URL.createObjectURL(new window.Blob([i.data]), {
                            type: "text/javascript"
                        });
                        for (var a = 0, u = pluginAvailableCallbacks; a < u.length; a += 1) {
                            var t = u[a];
                            t(pluginBlobURL)
                        }
                    }
        ...
        50: [function(require, module, exports) {
            ...
            "../source/canvas_source": 40,
            "../source/geojson_source": 41,
            "../source/image_source": 44,
            "../source/raster_tile_source": 48,
            "../source/vector_tile_source": 54,
            "../source/video_source": 56,
            "../util/util": 129
        }],
        51: [function(require, module, exports) {
            ...
            var Source = require("./source"),
                ...
                SourceCache = function(e) {
                    function t(t, o, i) {
                        e.call(this), this.id = t, this.dispatcher = i, this.on("source.load", function() {
                            this._sourceLoaded = !0
                        }), this.on("error", function() {
                            this._sourceErrored = !0
                        }), this.on("data", function(e) {
                            this._sourceLoaded && "source" === e.dataType && (this.reload(), this.transform && this.update(this.transform))
                    ...
                    return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.onAdd = function(e) {
                        ...
                        var e = this;
                        this._cache.reset();
                        for (var t in this._tiles) e.reloadTile(t, "reloading")
                    }, t.prototype.reloadTile = function(e, t) {
                        var o = this._tiles[e];
                        "loading" !== o.state && (o.state = t), this.loadTile(o, this._tileLoaded.bind(this, o, e))
                    }, t.prototype._tileLoaded = function(e, t, o) {
                        return o ? (e.state = "errored", void this._source.fire("error", {
                            tile: e,
                            error: o
                        })) : (e.sourceCache = this, e.timeAdded = (new Date).getTime(), this._setTileReloadTimer(t, e), this._source.fire("data", {
                            tile: e,
                            coord: e.coord,
                            dataType: "tile"
                        ...
                        for (var i = this, r = e.z - 1; r >= t; r--) {
                            ...
                            if (i._cache.has(e.id)) return o[e.id] = !0, i._cache.get(e.id)
                        }
                        ...
                        if (t) return t;
                        var o = e.wrapped();
                        if (t = this._tiles[o.id], t || (t = this._cache.get(o.id), t && (t.redoPlacement(this._source), this._cacheTimers[o.id] && (clearTimeout(this._cacheTimers[o.id]), this._cacheTimers[o.id] = void 0, this._setTileReloadTimer(o.id, t)))), !t) {
                            var i = e.z,
                                r = i > this._source.maxzoom ? Math.pow(2, i - this._source.maxzoom) : 1;
                            t = new Tile(o, this._source.tileSize * r, this._source.maxzoom), this.loadTile(t, this._tileLoaded.bind(this, t, e.id))
                        }
                        return t.uses++, this._tiles[e.id] = t, this._source.fire("dataloading", {
                            tile: t,
                            coord: t.coord,
                            dataType: "tile"
                        }), t
                        ...
                        var t = this._tiles[e];
                        if (t && (t.uses--, delete this._tiles[e], this._timers[e] && (clearTimeout(this._timers[e]), this._timers[e] = void 0), this._source.fire("data", {
                                tile: t,
                                coord: t.coord,
                                dataType: "tile"
                            }), !(t.uses > 0)))
                        ...
                        var e = this;
                        for (var t in this._tiles) e.removeTile(t);
                        this._cache.reset()
        ...
        52: [function(require, module, exports) {
            ...
            var util = require("../util/util"),
                ...
                Tile = function(e, t, i) {
                    this.coord = e, this.uid = util.uniqueId(), this.uses = 0, this.tileSize = t, this.sourceMaxZoom = i, this.buckets = {}, this.expires = null, this.cacheControl = null, this.state = "loading"
                };
            Tile.prototype.registerFadeDuration = function(e, t) {
                ...
                if ("unloaded" !== this.state) {
                    ...
                    for (var o in this.buckets) {
                        var s = i.buckets[o];
                        "symbol" === s.layers[0].type && (s.destroy(), delete i.buckets[o])
                    }
                    util.extend(this.buckets, Bucket.deserialize(e.buckets, t))
                }
            }, Tile.prototype.unloadVectorData = function() {
                var e = this;
                for (var t in this.buckets) e.buckets[t].destroy();
                this.buckets = {}, this.collisionBoxArray = null, this.symbolQuadsArray = null, this.symbolInstancesArray = null, this.collisionTile = null, this.featureIndex = null, this.state = "unloaded"
                ...
                if ("vector" === e.type || "geojson" === e.type) return "loaded" !== this.state ? void(this.redoWhenDone = !0) : void(this.collisionTile && (this.state = "reloading", e.dispatcher.send("redoPlacement", {
                    ...
                    t.reloadSymbolData(o, e.map.style), e.fire("data", {
                        tile: t,
                        coord: t.coord,
                        dataType: "tile"
                    }), e.map && (e.map.painter.tileExtentVAO.vao = null), t.state = "loaded", t.redoWhenDone && (t.redoWhenDone = !1, t.redoPlacement(e))
                }, this.workerID)))
                ...
                if (this.rawTileData) {
                    ...
                    if (o)
                        for (var s = featureFilter(t && t.filter), r = {
                                z: this.coord.z,
                                x: this.coord.x,
                                y: this.coord.y
                            }, a = 0; a < o.length; a++) {
                ...
                e.cacheControl && (this.cacheControl = e.cacheControl), e.expires && (this.expires = e.expires)
            }, Tile.prototype.getExpiry = function() {
                if (this.cacheControl) {
                    var e = util.parseCacheControl(this.cacheControl);
                    if (e["max-age"]) return this.timeAdded + 1e3 * e["max-age"]
                } else if (this.expires) return new Date(this.expires).getTime()
            }, module.exports = Tile;
        }, {
            "../data/bucket": 2,
            "../data/feature_index": 12,
            "../symbol/collision_box": 78,
            "../symbol/collision_tile": 80,
            "../symbol/symbol_instances": 89,
            "../symbol/symbol_quads": 90,
            "../util/util": 129,
            "../util/vectortile_to_geojson": 130,
            "feature-filter": 138,
            "pbf": 196,
                ...
                VectorTileSource = function(e) {
                    ...
                    return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.load = function() {
                        ...
                        function i(i, o) {
                            if (!e.aborted) {
                                if (i) return t(i);
                                e.setExpiryData(o), e.loadVectorData(o, this.map.painter), e.redoWhenDone && (e.redoWhenDone = !1, e.redoPlacement(this)), t(null), e.reloadCallback && (this.loadTile(e, e.reloadCallback), e.reloadCallback = null)
                            }
                        }
        ...
        57: [function(require, module, exports) {
            ...
            "../style/style_layer_index": 71,
            "../util/actor": 108,
            "./geojson_worker_source": 42,
            "./rtl_text_plugin": 49,
            "./vector_tile_worker_source": 55
        }],
        58: [function(require, module, exports) {
            ...
            function recalculateLayers(e, r) {
                for (var i = 0, s = e.layers; i < s.length; i += 1) {
                    var o = s[i];
                    o.recalculate(r)
                }
            }

            function serializeBuckets(e, r) {
            ...
            WorkerTile.prototype.parse = function(e, r, i, s) {
                var o = this;
                e.layers || (e = {
                    layers: {
                        _geojsonTileLayer: e
                ...
                var l = new DictionaryCoder(Object.keys(e.layers).sort()),
                    t = new FeatureIndex(this.coord, this.overscaling);
                t.bucketLayerIDs = {};
                var a = {},
                    n = 0,
                    c = {
                ...
                for (var y in u) {
                    var h = e.layers[y];
                    if (h) {
                        1 === h.version && util.warnOnce('Vector tile source "' + o.source + '" layer "' + y + '" does not use vector tile spec v2 and therefore may have some rendering errors.');
                        for (var m = l.encode(y), d = [], b = 0; b < h.length; b++) {
                            var v = h.feature(b);
                            v.index = b, v.sourceLayerIndex = m, d.push(v)
                        }
                        for (var f = 0, p = u[y]; f < p.length; f += 1) {
                            var g = p[f],
                                x = g[0];
                            if (!(x.minzoom && o.zoom < x.minzoom || x.maxzoom && o.zoom >= x.maxzoom || x.layout && "none" === x.layout.visibility)) {
                                for (var z = 0, A = g; z < A.length; z += 1) {
                                    var B = A[z];
                                    B.recalculate(o.zoom)
                                }
                                var k = a[x.id] = x.createBucket({
                                    index: n,
                                    layers: g,
                                    zoom: o.zoom,
                                    overscaling: o.overscaling,
                                    collisionBoxArray: o.collisionBoxArray,
                                    symbolQuadsArray: o.symbolQuadsArray,
                                    symbolInstancesArray: o.symbolInstancesArray
                                });
                                k.populate(d, c), t.bucketLayerIDs[n] = g.map(function(e) {
                                    return e.id
                                }), n++
                            }
                        }
                ...
                var I = function(e) {
                    ...
                    var r = [];
                    s(null, {
                        buckets: serializeBuckets(util.values(a), r),
                        featureIndex: t.serialize(r),
                        collisionTile: e.serialize(r),
                        collisionBoxArray: o.collisionBoxArray.serialize(),
                        symbolInstancesArray: o.symbolInstancesArray.serialize(),
                        symbolQuadsArray: o.symbolQuadsArray.serialize()
                    }, r)
                };
                this.symbolBuckets = [];
                for (var w = r.symbolOrder.length - 1; w >= 0; w--) {
                    var C = a[r.symbolOrder[w]];
                    C && o.symbolBuckets.push(C)
                }
                if (0 === this.symbolBuckets.length) return I(new CollisionTile(this.angle, this.pitch, this.collisionBoxArray));
                var T = 0,
                    q = Object.keys(c.iconDependencies),
                    D = util.mapObject(c.glyphDependencies, function(e) {
                        return Object.keys(e).map(Number)
                    }),
                    O = function(e) {
                        if (e) return s(e);
                        if (T++, 2 === T) {
                            for (var r = new CollisionTile(o.angle, o.pitch, o.collisionBoxArray), i = 0, l = o.symbolBuckets; i < l.length; i += 1) {
                                var t = l[i];
                                recalculateLayers(t, o.zoom), t.prepare(D, q), t.place(r, o.showCollisionBoxes)
                            }
                            I(r)
                        }
                    };
                Object.keys(D).length ? i.send("getGlyphs", {
                    uid: this.uid,
                    stacks: D
                }, function(e, r) {
                    D = r, O(e)
                }) : O(), q.length ? i.send("getIcons", {
                    icons: q
                }, function(e, r) {
                    q = r, O(e)
                }) : O()
            }, WorkerTile.prototype.redoPlacement = function(e, r, i) {
                var s = this;
                if (this.angle = e, this.pitch = r, "done" !== this.status) return {};
                for (var o = new CollisionTile(this.angle, this.pitch, this.collisionBoxArray), l = 0, t = this.symbolBuckets; l < t.length; l += 1) {
                    var a = t[l];
                    recalculateLayers(a, s.zoom), a.place(o, i)
                }
                var n = [];
                return {
                    result: {
                        buckets: serializeBuckets(this.symbolBuckets, n),
                        collisionTile: o.serialize(n)
                    },
                    transferables: n
                }
                ...
                Light = function(t) {
                    ...
                    return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.prototype.set = function(t) {
                        ...
                        if (!this._validate(validateStyle.light, t)) {
                            ...
                            for (var e = 0, o = this.properties; e < o.length; e += 1) {
                                var n = o[e];
                        ...
                        var i = this;
                        for (var e in this._declarations) i.calculated[e] = i.getLightValue(e, {
                            zoom: t
                        })
                        ...
                        var o, n = this;
                        for (o in this._declarations) n._applyLightDeclaration(o, n._declarations[o], t, i, e)
        ...
        62: [function(require, module, exports) {
            ...
            module.exports = function r(o) {
                if (o && MapboxGLFunction.isFunctionDefinition(o)) return o.stops ? util.extend({}, o, {
                    stops: o.stops.map(function(o) {
                        return [o[0], r(o[1])]
                    })
                }) : o;
                if ("string" == typeof o) {
                    if (!cache[o]) {
                        var i = parseColorString(o);
                        if (!i) throw new Error("Invalid color " + o);
                        cache[o] = [i[0] / 255 * i[3], i[1] / 255 * i[3], i[2] / 255 * i[3], i[3]]
                    }
                    return cache[o]
                }
                if (Array.isArray(o)) return o;
                throw new Error("Invalid color " + o)
            };
        }, {
            "../util/util": 129,
            "csscolorparser": 135,
            "mapbox-gl-function": 163
        }],
        63: [function(require, module, exports) {
            ...
            var Evented = require("../util/evented"),
                ...
                deref = require("mapbox-gl-style-spec/lib/deref"),
                diff = require("mapbox-gl-style-spec/lib/diff"),
                rtlTextPlugin = require("../source/rtl_text_plugin"),
                ...
                Style = function(e) {
                    function t(t, r, i) {
                        var o = this;
                        e.call(this), this.map = r, this.animationLoop = r && r.animationLoop || new AnimationLoop, this.dispatcher = new Dispatcher(getWorkerPool(), this), this.spriteAtlas = new SpriteAtlas(1024, 1024), this.lineAtlas = new LineAtlas(256, 512), this._layers = {}, this._order = [], this.sourceCaches = {}, this.zoomHistory = {}, this._loaded = !1, util.bindAll(["_redoPlacement"], this), this._resetUpdates(), i = util.extend({
                        ...
                        rtlTextPlugin.registerForPluginAvailability(function(e) {
                            s.dispatcher.broadcast("loadRTLTextPlugin", e, rtlTextPlugin.errorCallback);
                        ...
                        "string" == typeof t ? ajax.getJSON(mapbox.normalizeStyleURL(t), a) : browser.frame(a.bind(this, null, t)), this.on("source.load", function(e) {
                    ...
                    return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype._validateLayer = function(e) {
                        ...
                        var t = this;
                        if (this._loaded) {
                            for (var r in this.sourceCaches) t.sourceCaches[r].used = !1;
                            this._updateZoomHistory(e);
                            for (var i = 0, o = this._order; i < o.length; i += 1) {
                                var s = o[i],
                                    a = t._layers[s];
                        ...
                        if (this._changed) {
                            ...
                            for (var s in this._updatedSources) {
                        ...
                        var i = ["vector", "raster", "geojson", "video", "image", "canvas"],
                            o = i.indexOf(t.type) >= 0;
                        if (!o || !this._validate(validateStyle.source, "sources." + e, t, null, r)) {
                            var s = this.sourceCaches[e] = new SourceCache(e, t, this.dispatcher);
                            s.style = this, s.setEventedParent(this, function() {
                                return {
                                    isSourceLoaded: s.loaded(),
                                    source: s.serialize(),
                                    sourceId: e
                                }
                            }), s.onAdd(this.map), this._changed = !0
                        }
                        ...
                        for (var t = this, r = [], i = this._order.length - 1; i >= 0; i--)
                            for (var o = t._order[i], s = 0, a = e; s < a.length; s += 1) {
                                var n = a[s],
                                    l = n[o];
                                if (l)
                                    for (var d = 0, h = l; d < h.length; d += 1) {
                                        var u = h[d];
                                        r.push(u)
                                    }
                            }
                        ...
                        for (var u in this.sourceCaches)
                            if (!t.layers || s[u]) {
                                var c = QueryFeatures.rendered(o.sourceCaches[u], o._layers, e, t, r, i);
                                h.push(c)
                            }
                        ...
                        var e = this;
                        for (var t in this.sourceCaches) e.sourceCaches[t].clearTiles();
                        ...
                        var t = this;
                        for (var r in this.sourceCaches) t.sourceCaches[r].update(e)
                    }, t.prototype._redoPlacement = function() {
                        var e = this;
                        for (var t in this.sourceCaches) e.sourceCaches[t].redoPlacement()
                    }, t.prototype.getIcons = function(e, t, r) {
                        var i = this,
                            o = function() {
                                i.spriteAtlas.setSprite(i.sprite), i.spriteAtlas.addIcons(t.icons, r)
                            };
                        this.sprite.loaded() ? o() : this.sprite.on("data", o)
            ...
            "../global_worker_pool": 22,
            "../render/line_atlas": 35,
            "../source/query_features": 47,
            "../source/rtl_text_plugin": 49,
            "../source/source": 50,
            "../source/source_cache": 51,
            "../symbol/glyph_source": 83,
            "../symbol/sprite_atlas": 88,
            "../util/ajax": 109,
            "../util/browser": 110,
            "../util/dispatcher": 116,
            "../util/evented": 118,
            ...
            "./validate_style": 74,
            "mapbox-gl-function": 163,
            "mapbox-gl-style-spec/lib/deref": 164,
            "mapbox-gl-style-spec/lib/diff": 165
        }],
        64: [function(require, module, exports) {
            ...
            var MapboxGLFunction = require("mapbox-gl-function"),
                ...
                util = require("../util/util"),
                StyleDeclaration = function(t, o) {
                    var i = this;
                    this.value = util.clone(o), this.isFunction = MapboxGLFunction.isFunctionDefinition(o), this.json = JSON.stringify(this.value), this.minimum = t.minimum, this.isColor = "color" === t.type;
                    var n = this.isColor && this.value ? parseColor(this.value) : o,
                        s = t.default;
                    if (s && "color" === t.type && (s = parseColor(s)), this.function = MapboxGLFunction[t.function || "piecewise-constant"](n, s), this.isFeatureConstant = this.function.isFeatureConstant, this.isZoomConstant = this.function.isZoomConstant, !this.isFeatureConstant && !this.isZoomConstant) {
                        this.stopZoomLevels = [];
                        for (var e = [], a = 0, r = this.value.stops; a < r.length; a += 1) {
                            var l = r[a],
                                u = l[0].zoom;
                            i.stopZoomLevels.indexOf(u) < 0 && (i.stopZoomLevels.push(u), e.push([u, e.length]))
                        }
            ...
            StyleDeclaration.prototype.calculate = function(t, o) {
                var i = this.function(t && t.zoom, o || {});
                return this.isColor && i ? parseColor(i) : void 0 !== this.minimum && i < this.minimum ? this.minimum : i
            }, StyleDeclaration.prototype.calculateInterpolationT = function(t, o) {
                return this.functionInterpolationT(t && t.zoom, o || {})
        ...
        65: [function(require, module, exports) {
            ...
            var util = require("../util/util"),
                ...
                StyleLayer = function(t) {
                    function i(i) {
                        ...
                        for (e in this._paintSpecifications) a.paint[e] = a.getPaintValue(e);
                        for (n in this._layoutSpecifications) a._updateLayoutValue(n)
                    }
                    return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.prototype.setLayoutProperty = function(t, i, a) {
                        ...
                        for (l in this._paintTransitions) l in r || o._applyPaintDeclaration(l, null, i, a, e, n)
                        ...
                        var i = this;
                        for (var a in this._paintTransitions) i.paint[a] = i.getPaintValue(a, {
                            zoom: t
                        });
                        for (var e in this._layoutFunctions) i.layout[e] = i.getLayoutValue(e, {
                            zoom: t
                        })
                    }, i.prototype.serialize = function() {
                        var t = this,
            ...
            "./parse_color": 62,
            "./style_declaration": 64,
            "./style_layer/circle_style_layer": 66,
            "./style_layer/fill_extrusion_style_layer": 67,
            "./style_layer/fill_style_layer": 68,
            "./style_layer/line_style_layer": 69,
            "./style_layer/symbol_style_layer": 70,
            "./style_spec": 72,
            "./style_transition": 73,
            "./validate_style": 74
        }],
        ...
        67: [function(require, module, exports) {
            ...
            "../../data/bucket/fill_extrusion_bucket": 5,
            "../style_layer": 65
        }],
        ...
        71: [function(require, module, exports) {
            ...
            var StyleLayer = require("./style_layer"),
                util = require("../util/util"),
                featureFilter = require("feature-filter"),
                groupByLayout = require("mapbox-gl-style-spec/lib/group_by_layout"),
            ...
            StyleLayerIndex.prototype.replace = function(e) {
                ...
                for (var i = this, a = 0, l = e; a < l.length; a += 1) {
                    ...
                    var o = i._layers[y.id] = StyleLayer.create(y);
                    o.updatePaintTransitions({}, {
                        transition: !1
                    }), o.filter = featureFilter(o.filter)
                }
                ...
                for (var f = groupByLayout(util.values(this._layerConfigs)), p = 0, d = f; p < d.length; p += 1) {
                    var h = d[p],
                        ...
                        c = v[0];
                    if (!c.layout || "none" !== c.layout.visibility) {
                        var g = c.source || "",
                            _ = i.familiesBySource[g];
                        _ || (_ = i.familiesBySource[g] = {});
                        var m = c.sourceLayer || "_geojsonTileLayer",
                            L = _[m];
                        L || (L = _[m] = []), L.push(v)
                    }
                }
            ...
            "./style_layer": 65,
            "feature-filter": 138,
            "mapbox-gl-style-spec/lib/group_by_layout": 167
        }],
        72: [function(require, module, exports) {
            "use strict";
            module.exports = require("mapbox-gl-style-spec/reference/latest.min");
        }, {
            "mapbox-gl-style-spec/reference/latest.min": 191
        }],
        ...
        74: [function(require, module, exports) {
            ...
            "mapbox-gl-style-spec/lib/validate_style.min": 189
        }],
        ...
        82: [function(require, module, exports) {
            ...
            var ShelfPack = require("shelf-pack"),
                ...
                MAX_SIZE = 2048,
                GlyphAtlas = function() {
                    this.width = DEFAULT_SIZE, this.height = DEFAULT_SIZE, this.bin = new ShelfPack(this.width, this.height), this.index = {}, this.ids = {}, this.data = new Uint8Array(this.width * this.height)
                };
            GlyphAtlas.prototype.getGlyphs = function() {
                ...
                var t, i, e, h = this,
                    r = {};
                for (var s in this.ids) t = s.split("#"), i = t[0], e = t[1], r[i] || (r[i] = {}), r[i][e] = h.index[s];
                return r
                ...
                var a = e.width + 2 * h,
                    ...
                    u = n + 2 * E;
                T += 4 - T % 4, u += 4 - u % 4;
                var l = this.bin.packOne(T, u);
                if (l || (this.resize(), l = this.bin.packOne(T, u)), !l) return util.warnOnce("glyph bitmap overflow"), null;
                this.index[s] = l, this.ids[s] = [t];
                for (var d = this.data, A = e.bitmap, _ = 0; _ < n; _++)
                    for (var p = r.width * (l.y + _ + E) + l.x + E, o = a * _, R = 0; R < a; R++) d[p + R] = A[o + R];
                ...
                if (!(i >= MAX_SIZE || e >= MAX_SIZE)) {
                    this.texture && (this.gl && this.gl.deleteTexture(this.texture), this.texture = null), this.width *= SIZE_GROWTH_RATE, this.height *= SIZE_GROWTH_RATE, this.bin.resize(this.width, this.height);
        ...
        83: [function(require, module, exports) {
            ...
            "../symbol/glyph_atlas": 82,
            "../util/ajax": 109,
            "../util/glyphs": 120,
            "../util/mapbox": 125,
            "../util/verticalize_punctuation": 131,
            "pbf": 196
        }],
        ...
        85: [function(require, module, exports) {
            ...
            function getIconQuads(t, e, a, n, i, o, l, h, r) {
                ...
                } else s = new Point(d, y), g = new Point(P, y), u = new Point(P, M), c = new Point(d, M);
            ...
            function getGlyphQuads(t, e, a, n, i, o) {
                for (var l = i.layout["text-rotate"] * Math.PI / 180, h = i.layout["text-keep-upright"], r = e.positionedGlyphs, s = [], g = 0; g < r.length; g++) {
                    ...
                    if (c) {
                        var m = c.rect;
                        if (m) {
                            var f, x = (u.x + c.advance / 2) * a,
                                d = minScale;
                            o ? (f = [], d = getSegmentGlyphs(f, t, x, n, t.segment, !0), h && (d = Math.min(d, getSegmentGlyphs(f, t, x, n, t.segment, !1)))) : f = [{
        ...
        86: [function(require, module, exports) {
            ...
            module.exports = function(e, r) {
                var o = resolveTokens(e.properties, r["text-field"]);
                if (o) {
                    o = o.toString();
                    var t = r["text-transform"];
                    return "uppercase" === t ? o = o.toLocaleUpperCase() : "lowercase" === t && (o = o.toLocaleLowerCase()), o
                }
            };
        }, {
            "../util/token": 128
        ...
        88: [function(require, module, exports) {
            ...
            SpriteAtlas.prototype.allocateImage = function(t, i) {
                ...
                if (!this.data) {
                    ...
                    for (var h = 0; h < this.data.length; h++) t.data[h] = 0
                }
                ...
                if (this.sprite.imgData) {
                    ...
                    var a = this.data,
                        s = 1;
                    copyBitmap(h, this.sprite.width, i.x, i.y, a, this.width * this.pixelRatio, (t.x + s) * this.pixelRatio, (t.y + s) * this.pixelRatio, i.width, i.height, e), this.dirty = !0
                }
                ...
                for (var e = this, h = 0; h < t.length; h++) e.getImage(t[h]);
                i(null, this.images)
        ...
        89: [function(require, module, exports) {
            ...
            var createStructArrayType = require("../util/struct_array"),
                Point = require("point-geometry"),
                SymbolInstancesArray = createStructArrayType({
                    members: [{
                        type: "Uint16",
        ...
        90: [function(require, module, exports) {
            ...
            var createStructArrayType = require("../util/struct_array"),
                ...
                SymbolQuadsArray = createStructArrayType({
                    members: [{
                        type: "Int16",
                        name: "anchorPointX"
                    }, {
        ...
        91: [function(require, module, exports) {
            ...
            "../util/dom": 117,
            "./handler/box_zoom": 97,
            "./handler/dblclick_zoom": 98,
            "./handler/drag_pan": 99,
            "./handler/drag_rotate": 100,
            "./handler/keyboard": 101,
            "./handler/scroll_zoom": 102,
            "./handler/touch_zoom_rotate": 103,
            "point-geometry": 197
        }],
            ...
            var util = require("../util/util"),
                ...
                Camera = function(t) {
                    ...
                    return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.prototype.getCenter = function() {
                        ...
                        var o = Point.convert(i.offset),
                            n = this.transform,
                            r = n.project(t.getNorthWest()),
                            s = n.project(t.getSouthEast()),
                            a = s.sub(r),
                            h = (n.width - 2 * i.padding - 2 * Math.abs(o.x)) / a.x,
                            u = (n.height - 2 * i.padding - 2 * Math.abs(o.y)) / a.y;
                        return i.center = n.unproject(r.add(s).div(2)), i.zoom = Math.min(n.scaleZoom(n.scale * Math.min(h, u)), i.maxZoom), i.bearing = 0, i.linear ? this.easeTo(i, e) : this.flyTo(i, e)
                        ...
                        var g = r.locationPoint(o);
                        return t.animate === !1 && (t.duration = 0), this.zooming = p !== a, this.rotating = h !== c, this.pitching = m !== u, t.smoothEasing && 0 !== t.duration && (t.easing = this._smoothOutEasing(t.duration)), t.noMoveStart || (this.moving = !0, this.fire("movestart", i)), this.zooming && this.fire("zoomstart", i), clearTimeout(this._onEaseEnd), this._ease(function(t) {
                            this.zooming && (r.zoom = interpolate(a, p, t)), this.rotating && (r.bearing = interpolate(h, c, t)), this.pitching && (r.pitch = interpolate(u, m, t)), r.setLocationAtPoint(o, g.add(n.sub(g)._mult(t))), this.fire("move", i), this.zooming && this.fire("zoom", i), this.rotating && this.fire("rotate", i), this.pitching && this.fire("pitch", i)
                        }, function() {
                        ...
                        var d = s.zoomScale(m - h),
                            ...
                            _ = v.sub(l).mag();
                        if ("minZoom" in t) {
                            var M = util.clamp(Math.min(t.minZoom, h, m), s.minZoom, s.maxZoom),
                                T = z / s.zoomScale(M - h);
                            b = Math.sqrt(T / _ * 2)
                        }
                        var E = b * b,
                            ...
                            P = (e(1) - x) / b;
                        if (Math.abs(_) < 1e-6) {
                            if (Math.abs(z - y) < 1e-6) return this.easeTo(t);
                            var B = y < z ? -1 : 1;
                            P = Math.abs(Math.log(y / z)) / b, Z = function() {
                                return 0
                            }, L = function(t) {
                                return Math.exp(B * b * t)
                            }
                        }
                        ...
                        return this.moving = !0, this.zooming = !0, u !== g && (this.rotating = !0), p !== f && (this.pitching = !0), this.fire("movestart", i), this.fire("zoomstart", i), this._ease(function(t) {
                            var e = t * P,
                                o = Z(e),
                                n = 1 / L(e);
                            s.zoom = h + s.scaleZoom(n), s.center = s.unproject(l.add(v.sub(l).mult(o)).mult(n)), this.rotating && (s.bearing = interpolate(u, g, t)), this.pitching && (s.pitch = interpolate(p, f, t)), this.fire("move", i), this.fire("zoom", i), this.rotating && this.fire("rotate", i), this.pitching && this.fire("pitch", i)
                        }, function() {
        ...
        93: [function(require, module, exports) {
            ...
            AttributionControl.prototype.getDefaultPosition = function() {
                ...
                "source" === t.dataType && (this._updateAttributions(), this._updateEditLink())
            ...
            DragPanHandler.prototype.isEnabled = function() {
                ...
                if (this.isActive()) {
                    ...
                    var u = a.mult(inertiaLinearity / s),
                        h = u.mag();
                    h > inertiaMaxSpeed && (h = inertiaMaxSpeed, u._unit()._mult(h));
                    var d = h / (inertiaDeceleration * inertiaLinearity),
                        v = u.mult(-d / 2);
                    this._map.panBy(v, {
                        duration: 1e3 * d,
                ...
                this._ignoreEvent(t) || (this._onUp(t), window.document.removeEventListener("mousemove", this._onMove), window.document.removeEventListener("mouseup", this._onMouseUp))
                ...
                var n = 1,
                    i = 0;
                return "mousemove" === t.type ? t.buttons & 0 === n : t.button !== i
        ...
        100: [function(require, module, exports) {
            ...
            DragRotateHandler.prototype.isEnabled = function() {
                ...
                this._ignoreEvent(t) || this.isActive() || (window.document.addEventListener("mousemove", this._onMove), window.document.addEventListener("mouseup", this._onUp), this._active = !1, this._inertia = [
                ...
                if (!this._ignoreEvent(t)) {
                    this.isActive() || (this._active = !0, this._fireEvent("rotatestart", t), this._fireEvent("movestart", t));
                    var e = this._map;
                    e.stop();
                    var i = this._pos,
                        ...
                        h = this._inertia,
                        _ = h[h.length - 1];
                    this._drainInertiaBuffer(), h.push([Date.now(), e._normalizeBearing(o, _[1])]), e.transform.bearing = o, this._pitchWithRotate && (e.transform.pitch = s), this._fireEvent("rotate", t), this._fireEvent("move", t), this._pos = n
                }
            }, DragRotateHandler.prototype._onUp = function(t) {
                var e = this;
                if (!this._ignoreEvent(t) && (window.document.removeEventListener("mousemove", this._onMove), window.document.removeEventListener("mouseup", this._onUp), this.isActive())) {
                    ...
                    var p = l / (inertiaDeceleration * inertiaLinearity),
                        g = u * l * (p / 2);
                ...
                var i = t.ctrlKey ? 1 : 2,
                    n = t.ctrlKey ? 0 : 2,
                    r = t.button;
                return "undefined" != typeof InstallTrigger && 2 === t.button && t.ctrlKey && window.navigator.platform.toUpperCase().indexOf("MAC") >= 0 && (r = 0), "mousemove" === t.type ? t.buttons & 0 === i : r !== n
        ...
        105: [function(require, module, exports) {
            ...
            var util = require("../util/util"),
                ...
                Map = function(t) {
                    function e(e) {
                        ...
                        var o = new Transform(e.minZoom, e.maxZoom, e.renderWorldCopies);
                        if (t.call(this, o, e), this._interactive = e.interactive, this._failIfMajorPerformanceCaveat = e.failIfMajorPerformanceCaveat, this._preserveDrawingBuffer = e.preserveDrawingBuffer, this._trackResize = e.trackResize, this._bearingSnap = e.bearingSnap, "string" == typeof e.container) {
                        ...
                        this.animationLoop = new AnimationLoop, e.maxBounds && this.setMaxBounds(e.maxBounds), util.bindAll(["_onWindowOnline", "_onWindowResize", "_contextLost", "_contextRestored", "_update", "_render", "_onData", "_onDataLoading"], this), this._setupContainer(), this._setupPainter(), this.on("move", this._update.bind(this, !1)), this.on("zoom", this._update.bind(this, !0)), this.on("moveend", function() {
                            i.animationLoop.set(300), i._rerender()
                            ...
                            bearing: e.bearing,
                            pitch: e.pitch
                        }), this._classes = [], this.resize(), e.classes && this.setClasses(e.classes), e.style && this.setStyle(e.style), e.attributionControl && this.addControl(new AttributionControl), this.on("style.load", function() {
                    ...
                    return e.prototype.addControl = function(t, e) {
                        ...
                        var i = t.onAdd(this),
                            o = this._controlPositions[e];
                        return e.indexOf("bottom") !== -1 ? o.insertBefore(i, o.firstChild) : o.appendChild(i), this
                        ...
                        return i < 0 || "" === t ? this : (this._classes.splice(i, 1), this._classOptions = e, this.style && this.style.updateClasses(), this._update(!0))
                    }, e.prototype.setClasses = function(t, e) {
                        util.warnOnce("Style classes are deprecated and will be removed in an upcoming release of Mapbox GL JS.");
                        for (var i = {}, o = 0; o < t.length; o++) "" !== t[o] && (i[t[o]] = !0);
                        return this._classes = Object.keys(i), this._classOptions = e, this.style && this.style.updateClasses(), this._update(!0)
                        ...
                        var t = this._containerDimensions(),
                            e = t[0],
                            i = t[1];
                        this._resizeCanvas(e, i), this.transform.resize(e, i), this.painter.resize(e, i);
                        var o = this.painter.gl,
                            s = o.getParameter(o.MAX_RENDERBUFFER_SIZE) / 2;
                        return (this._canvas.width > s || this._canvas.height > s) && util.warnOnce("Map is larger than maximum size supported by this system (" + s + "px by " + s + "px)."), this.fire("movestart").fire("move").fire("resize").fire("moveend")
                        ...
                        var e, i = {};
                        return 2 === arguments.length ? (e = arguments[0], i = arguments[1]) : 1 === arguments.length && t(arguments[0]) ? e = arguments[0] : 1 === arguments.length && (i = arguments[0]), this.style.queryRenderedFeatures(this._makeQueryGeometry(e), i, this.transform.zoom, this.transform.angle)
                        ...
                        var i, o = t instanceof Point || "number" == typeof t[0];
                        if (o) {
                            var s = Point.convert(t);
                            i = [s]
                        } else {
                            var r = [Point.convert(t[0]), Point.convert(t[1])];
                            i = [r[0], new Point(r[1].x, r[0].y), r[1], new Point(r[0].x, r[1].y), r[0]]
                        }
                        ...
                        var i = (!e || e.diff !== !1) && this.style && t && !(t instanceof Style) && "string" != typeof t;
                        if (i) try {
                    ...
                    }, e.prototype.addSourceType = function(t, e, i) {
                    ...
                    }, e.prototype.setLayerZoomRange = function(t, e, i) {
                        return this.style.setLayerZoomRange(t, e, i), this._update(!0), this
                    }, e.prototype.getFilter = function(t) {
                        return this.style.getFilter(t)
                    }, e.prototype.setPaintProperty = function(t, e, i, o) {
                        return this.style.setPaintProperty(t, e, i, o), this._update(!0), this
                    }, e.prototype.getPaintProperty = function(t, e, i) {
                        return this.style.getPaintProperty(t, e, i)
                    }, e.prototype.setLayoutProperty = function(t, e, i) {
                        return this.style.setLayoutProperty(t, e, i), this._update(!0), this
                        ...
                        var o = this._controlContainer = DOM.create("div", "mapboxgl-control-container", t),
                            s = this._controlPositions = {};
                        ["top-left", "top-right", "bottom-left", "bottom-right"].forEach(function(t) {
                            s[t] = DOM.create("div", "mapboxgl-ctrl-" + t, o)
                        })
                        ...
                        this._hash && this._hash.remove(), browser.cancelFrame(this._frameId), this.setStyle(null), "undefined" != typeof window && window.removeEventListener("resize", this._onWindowResize, !1);
                    ...
                    }, i.showTileBoundaries.get = function() {
                        return !!this._showTileBoundaries
                    }, i.showTileBoundaries.set = function(t) {
                        this._showTileBoundaries !== t && (this._showTileBoundaries = t, this._update())
                    }, i.showCollisionBoxes.get = function() {
                        return !!this._showCollisionBoxes
                    }, i.showCollisionBoxes.set = function(t) {
                        this._showCollisionBoxes !== t && (this._showCollisionBoxes = t, this.style._redoPlacement())
                    }, i.showOverdrawInspector.get = function() {
                        return !!this._showOverdrawInspector
                    }, i.showOverdrawInspector.set = function(t) {
                        this._showOverdrawInspector !== t && (this._showOverdrawInspector = t, this._update())
                    }, i.repaint.get = function() {
                        return !!this._repaint
                    }, i.repaint.set = function(t) {
            ...
            "./bind_handlers": 91,
            "./camera": 92,
            "./control/attribution_control": 93,
            "./hash": 104,
            "mapbox-gl-supported": 193,
            "point-geometry": 197
        }],
        ...
        118: [function(require, module, exports) {
            ...
            Evented.prototype.on = function(e, t) {
                return this._listeners = this._listeners || {}, this._listeners[e] = this._listeners[e] || [], this._listeners[e].push(t), this
                ...
                if (this.listens(e)) {
                    ...
                    for (var s = this._listeners && this._listeners[e] ? this._listeners[e].slice() : [], i = 0; i < s.length; i++) s[i].call(n, t);
                    this._eventedParent && this._eventedParent.fire(e, util.extend({}, t, this._eventedParentData))
                } else util.endsWith(e, "error") && console.error(t && t.error || t || "Empty error event");
                return this
            }, Evented.prototype.listens = function(e) {
                return this._listeners && this._listeners[e] || this._eventedParent && this._eventedParent.listens(e)
            }, Evented.prototype.setEventedParent = function(e, t) {
                return this._eventedParent = e, this._eventedParentData = "function" == typeof t ? t() : t, this
        ...
        124: [function(require, module, exports) {
            ...
            LRUCache.prototype.reset = function() {
                var t = this;
                for (var e in this.data) t.onRemove(t.data[e]);
        ...
        125: [function(require, module, exports) {
            ...
            var config = require("./config"),
                ...
                help = "See https://www.mapbox.com/developers/api/#access-tokens";
        ...
        127: [function(require, module, exports) {
            ...
            StructArray.serialize = function() {
                ...
                for (var t = this, e = 0, r = this._usedTypes; e < r.length; e += 1) {
                    var i = r[e];
        ...
        129: [function(require, module, exports) {
            ...
            exports.warnOnce = function(r) {
                ...
                for (var e, t, n = 0, o = 0, a = r.length, i = a - 1; o < a; i = o++) e = r[o], t = r[i], n += (t.x - e.x) * (e.y + t.y);
                return n
        ...
        130: [function(require, module, exports) {
            ...
            prototypeAccessors.geometry.get = function() {
                ...
                for (var r in this) "_geometry" !== r && "_vectorTileFeature" !== r && (t[r] = e[r]);
                return t
        ...
        132: [function(require, module, exports) {
            ...
            WorkerPool.prototype.acquire = function(r) {
                var e = this;
                if (!this.workers) {
                    var o = require("../mapbox-gl").workerCount;
        ...
        161: [function(require, module, exports) {
            ...
            "lodash._getnative": 157,
            "lodash.isarguments": 158,
            "lodash.isarray": 159
        }],
        ...
        163: [function(require, module, exports) {
            ...
            function createFunction(t, o) {
                ...
                if (isFunctionDefinition(t)) {
                    var n, r = t.stops && "object" == typeof t.stops[0][0],
                        i = r || void 0 !== t.property,
                        s = r || !i,
                        a = t.stops && typeof(r ? t.stops[0][0].property : t.stops[0][0]),
                        p = t.type || o || ("string" === a ? "categorical" : "exponential");
                    if ("exponential" === p) n = evaluateExponentialFunction;
                    else if ("interval" === p) n = evaluateIntervalFunction;
                    else if ("categorical" === p) n = evaluateCategoricalFunction;
                    else {
                        if ("identity" !== p) throw new Error('Unknown function type "' + p + '"');
                        n = evaluateIdentityFunction
                    }
                    var u;
                    if (t.colorSpace && "rgb" !== t.colorSpace) {
                        if (!colorSpaces[t.colorSpace]) throw new Error("Unknown color space: " + t.colorSpace);
                        var c = colorSpaces[t.colorSpace];
                        t = JSON.parse(JSON.stringify(t));
                        for (var l = 0; l < t.stops.length; l++) t.stops[l] = [t.stops[l][0], c.forward(t.stops[l][1])];
                        u = c.reverse
                    } else u = identityFunction;
                    if (r) {
                        var f = {},
                            v = [];
                        for (l = 0; l < t.stops.length; l++) {
                            var y = t.stops[l];
                            void 0 === f[y[0].zoom] && (f[y[0].zoom] = {
                                zoom: y[0].zoom,
                                type: t.type,
                                property: t.property,
                                stops: []
                            }), f[y[0].zoom].stops.push([y[0].value, y[1]])
                        }
                        for (var F in f) v.push([f[F].zoom, createFunction(f[F])]);
                        e = function(o, e) {
                            return u(evaluateExponentialFunction({
                                stops: v,
                                base: t.base
                            }, o)(o, e))
                        }, e.isFeatureConstant = !1, e.isZoomConstant = !1
                    } else s ? (e = function(o) {
                        return u(n(t, o))
                    }, e.isFeatureConstant = !0, e.isZoomConstant = !1) : (e = function(o, e) {
                        return u(n(t, e[t.property]))
                    }, e.isFeatureConstant = !1, e.isZoomConstant = !0)
                } else e = function() {
                    return t
                }, e.isFeatureConstant = !0, e.isZoomConstant = !0;
                return e
            }

            function evaluateCategoricalFunction(t, o) {
                for (var e = 0; e < t.stops.length; e++)
                    if (o === t.stops[e][0]) return t.stops[e][1];
                return t.stops[0][1]
            }

            function evaluateIntervalFunction(t, o) {
                for (var e = 0; e < t.stops.length && !(o < t.stops[e][0]); e++);
                return t.stops[Math.max(e - 1, 0)][1]
            }

            function evaluateExponentialFunction(t, o) {
                for (var e = void 0 !== t.base ? t.base : 1, n = 0;;) {
                    if (n >= t.stops.length) break;
                    if (o <= t.stops[n][0]) break;
                    n++
                }
                return 0 === n ? t.stops[n][1] : n === t.stops.length ? t.stops[n - 1][1] : interpolate(o, e, t.stops[n - 1][0], t.stops[n][0], t.stops[n - 1][1], t.stops[n][1])
            }
            ...
            function interpolate(t, o, e, n, r, i) {
                return "function" == typeof r ? function() {
                    var s = r.apply(void 0, arguments),
                        a = i.apply(void 0, arguments);
                    return interpolate(t, o, e, n, s, a)
                } : r.length ? interpolateArray(t, o, e, n, r, i) : interpolateNumber(t, o, e, n, r, i)
            }

            function interpolateNumber(t, o, e, n, r, i) {
                var s, a = n - e,
                    p = t - e;
                return s = 1 === o ? p / a : (Math.pow(o, p) - 1) / (Math.pow(o, a) - 1), r * (1 - s) + i * s
            }

            function interpolateArray(t, o, e, n, r, i) {
                for (var s = [], a = 0; a < r.length; a++) s[a] = interpolateNumber(t, o, e, n, r[a], i[a]);
                return s
            }
        ...
        164: [function(require, module, exports) {
            ...
            function deref(e, r) {
                var f = {};
                for (var t in e) "ref" !== t && (f[t] = e[t]);
                return refProperties.forEach(function(e) {
                    e in r && (f[e] = r[e])
                }), f
            }

            function derefLayers(e) {
                e = e.slice();
                var r, f = Object.create(null);
                for (r = 0; r < e.length; r++) f[e[r].id] = e[r];
                for (r = 0; r < e.length; r++) "ref" in e[r] && (e[r] = deref(e[r], f[e[r].ref]));
                return e
            }
            var refProperties = require("./util/ref_properties");
            module.exports = derefLayers;
        }, {
            "./util/ref_properties": 170
        }],
        ...
        172: [function(require, module, exports) {
            ...
            "../error/validation_error": 166,
            "../util/extend": 168,
            "../util/get_type": 169,
            "./validate_array": 173,
            "./validate_boolean": 174,
            "./validate_color": 175,
            "./validate_constants": 176,
            "./validate_enum": 177,
            "./validate_filter": 178,
            "./validate_function": 179,
            "./validate_layer": 181,
            "./validate_light": 183,
            "./validate_number": 184,
            "./validate_object": 185,
        ...
        179: [function(require, module, exports) {
            ...
            module.exports = function(e) {
                function t(e) {
                    if ("identity" === u) return [new ValidationError(e.key, e.value, 'identity function may not have a "stops" property')];
                    var t = [],
                        a = e.value;
                ...
                function r(e) {
                    ...
                    if (c) {
                        ...
                        if (i && i > unbundle(r[0].zoom)) return [new ValidationError(o, r[0].zoom, "stop zoom values must appear in ascending order")];
                        unbundle(r[0].zoom) !== i && (i = unbundle(r[0].zoom), n = void 0), t = t.concat(validateObject({
                            key: o + "[0]",
                            value: r[0],
                            valueSpec: {
                                zoom: {}
                    ...
                    return t = t.concat(validate({
                        ...
                        style: e.style,
                        styleSpec: e.styleSpec
                    })), "number" === getType(r[0]) && "piecewise-constant" === l.function && r[0] % 1 !== 0 && t.push(new ValidationError(o + "[0]", r[0], "zoom level for piecewise-constant functions must be an integer")), t
                }
        ...
        181: [function(require, module, exports) {
            ...
            "../util/unbundle_jsonlint": 171,
            "./validate_filter": 178,
            "./validate_layout_property": 182,
            "./validate_object": 185,
            "./validate_paint_property": 186
        }],
        182: [function(require, module, exports) {
            ...
            module.exports = function(e) {
                ...
                if (e.valueSpec || o[l]) {
                    var s = [];
                    return "symbol" === e.layerType && ("icon-image" === l && t && !t.sprite ? s.push(new ValidationError(r, i, 'use of "icon-image" requires a style "sprite" property')) : "text-field" === l && t && !t.glyphs && s.push(new ValidationError(r, i, 'use of "text-field" requires a style "glyphs" property'))), s.concat(validate({
                        key: e.key,
                        value: i,
            ...
            module.exports = function(e) {
                ...
                for (var p in t) {
                    var s, c = p.split(".")[0],
                        d = i[c] || i["*"];
                    if (a[c]) s = a[c];
                    else if (i[c]) s = validateSpec;
                    else if (a["*"]) s = a["*"];
                    else {
                        if (!i["*"]) {
                            n.push(new ValidationError(r, t[p], 'unknown property "%s"', p));
                            continue
                        }
                        s = validateSpec
                    }
                ...
                for (c in i) i[c].required && void 0 === i[c].default && void 0 === t[c] && n.push(new ValidationError(r, t, 'missing required property "%s"', c));
                return n
            };
        }, {
            "../error/validation_error": 166,
        ...
        186: [function(require, module, exports) {
            ...
            module.exports = function(e) {
                ...
                return o && n[o[1]] && n[o[1]].transition ? validate({
                    ...
                    style: a,
                    styleSpec: t
                }) : e.valueSpec || n[l] ? validate({
                    key: e.key,
                    value: i,
                    valueSpec: e.valueSpec || n[l],
                    style: a,
                    styleSpec: t
                }) : [new ValidationError(r, i, 'unknown property "%s"', l)]
            };
        }, {
            "../error/validation_error": 166,
            "./validate": 172
        ...
        189: [function(require, module, exports) {
            ...
            "../reference/latest.min": 191,
            "./validate/validate": 172,
            "./validate/validate_constants": 176,
            "./validate/validate_filter": 178,
            "./validate/validate_glyphs_url": 180,
            "./validate/validate_layer": 181,
            "./validate/validate_layout_property": 182,
            "./validate/validate_light": 183,
            "./validate/validate_paint_property": 186,
            "./validate/validate_source": 187
        }],
        ...
        200: [function(require, module, exports) {
            ! function(t, e) {
                ...
                function t(t, e, s) {
                    s = s || {}, this.w = t || 64, this.h = e || 64, this.autoResize = !!s.autoResize, this.shelves = [], this.stats = {}, this.count = function(t) {
                        this.stats[t] = (0 | this.stats[t]) + 1
                    }
                }

                function e(t, e, s) {
                    this.x = 0, this.y = t, this.w = this.free = e, this.h = s
                }
                return t.prototype.pack = function(t, e) {
                    ...
                    return n
                }, t.prototype.packOne = function(t, s) {
                    for (var h, i, n = 0, r = {
                            shelf: -1,
                            waste: 1 / 0
                        }, o = 0; o < this.shelves.length; o++) {
                    ...
                    return !0
                }, e.prototype.alloc = function(t, e) {
        ...
        206: [function(require, module, exports) {
            ...
            "./lib/vectortile.js": 207,
            "./lib/vectortilefeature.js": 208,
            "./lib/vectortilelayer.js": 209
        }],
